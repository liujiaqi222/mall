(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ...
  ],
  {
    "0d19": function (t, e, i) {
      ...
      var n = {
        ...
        methods: {
          ...
          open: function (t) {
            this.list.length && ((this.currentIndex = t), (this.showBox = !0));
          },
          close: function () {
            this.showBox = !1;
          },
    ...
    "141a": function (t, e, i) {
      ...
      i("f717");
      var s = i("f0c5"),
        r = Object(s["a"])(a["default"], n["b"], n["c"], !1, null, "732b5737", null, !1, n["a"], void 0);
      e["default"] = r.exports;
    },
    "178d": function (t, e, i) {
      var n = i("24fb");
                    ...
                    [
                      i(
                        ...
                        t._l(t.list, function (t, e) {
                          return i(
                            "v-uni-swiper-item",
                            { key: e, staticClass: "flex flex-column justify-center align-center" },
                            [i("v-uni-image", { staticClass: "mask-swiper-img", attrs: { src: t, mode: "widthFix" } })],
                            1
                          );
                        }),
                        1
    ...
    "1e7a": function (t, e, i) {
      ...
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* crmeb颜色变量 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.sharing-packets[data-v-fb4784ca]{position:fixed;left:%?30?%;bottom:%?200?%;z-index:5;transition:all .3s ease-in-out 0s;opacity:1;-webkit-transform:scale(1);transform:scale(1)}.sharing-packets.right[data-v-fb4784ca]{left:%?-170?%}.sharing-packets .iconfont[data-v-fb4784ca]{width:%?44?%;height:%?44?%;border-radius:50%;text-align:center;line-height:%?44?%;background-color:#999;font-size:%?20?%;color:#fff;margin:0 auto;box-sizing:border-box;padding-left:1px}.sharing-packets .line[data-v-fb4784ca]{width:%?2?%;height:%?40?%;background-color:#999;margin:0 auto}.sharing-packets .sharing-con[data-v-fb4784ca]{width:%?187?%;height:%?210?%;position:relative}.sharing-packets .sharing-con uni-image[data-v-fb4784ca]{width:100%;height:100%}.sharing-packets .sharing-con .text[data-v-fb4784ca]{position:absolute;top:%?30?%;font-size:%?20?%;line-height:%?30?%;width:100%;text-align:center}.sharing-packets .sharing-con .text .money[data-v-fb4784ca]{font-size:%?32?%;line-height:%?42?%;font-weight:700;margin-top:%?5?%}.sharing-packets .sharing-con .text .money .label[data-v-fb4784ca]{font-size:%?20?%}.sharing-packets .sharing-con .text .tip[data-v-fb4784ca]{font-size:%?18?%;line-height:%?18?%;color:#999;margin-top:%?5?%}.sharing-packets .sharing-con .text .shareBut[data-v-fb4784ca]{font-size:%?22?%;line-height:%?48?%;color:#fff;margin-top:%?28?%}',
          "",
        ]),
        (t.exports = e);
    },
    "39ed": function (t, e, i) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }),
        (e.adminExpress = function (t, e) {
          return o.default.get("admin/order/express/" + t + "".concat(e ? "/refund" : ""));
        }),
        (e.aliPay = function (t, e) {
          return o.default.get("ali_pay", { key: t, quitUrl: e }, { noAuth: !0 });
        }),
        (e.cancelRefundOrder = function (t) {
          return o.default.post("order/refund/cancel/" + t);
        }),
        (e.cartDel = function (t) {
          "object" === (0, a.default)(t) && (t = t.join(","));
          return o.default.post("cart/del", { ids: t });
        }),
        (e.changeCartNum = function (t, e) {
          return o.default.post("cart/num", { id: t, number: e });
        }),
        (e.checkShipping = function (t, e) {
          return o.default.post("order/check_shipping", { cartId: t, new: e });
        }),
        (e.express = function (t, e) {
          return o.default.get("order/express/" + t + "".concat(e ? "/refund" : ""));
        }),
        (e.getCartCounts = function (t) {
          return o.default.get("cart/count", { numType: void 0 === t ? 0 : t });
        }),
        (e.getCartList = function (t) {
          return o.default.get("cart/list", t);
        }),
        (e.getCashierOrder = function (t, e) {
          return o.default.get("order/cashier/".concat(t, "/").concat(e));
        }),
        (e.getCouponsOrderPrice = function (t, e) {
          return o.default.get("coupons/order/" + t, e);
        }),
        (e.getInvoiceLink = function (t) {
          return o.default.get("v2/order/down_invoice/".concat(t));
        }),
        (e.getNewOrderList = function (t) {
          return o.default.get("order/refund/list", t);
        }),
        (e.getOrderDetail = function (t, e) {
          return o.default.get("order/detail/" + t + "".concat(e ? "/".concat(e) : ""));
        }),
        (e.getOrderList = function (t) {
          return o.default.get("order/list", t);
        }),
        (e.getRefundOrderDetail = function (t, e) {
          return o.default.get("order/refund_detail/" + t + "".concat(e ? "/".concat(e) : ""));
        }),
        (e.getResetCart = function (t) {
          return o.default.post("v2/reset_cart", t);
        }),
        (e.offlineCheckPrice = function (t) {
          return o.default.post("order/offline/check/price", t);
        }),
        (e.offlineCreate = function (t) {
          return o.default.post("order/offline/create", t);
        }),
        (e.ordeRefundReason = function () {
          return o.default.get("order/refund/reason");
        }),
        (e.orderAgain = function (t) {
          return o.default.post("order/again", { uni: t });
        }),
        (e.orderCancel = function (t) {
          return o.default.post("order/cancel", { id: t });
        }),
        (e.orderComment = function (t) {
          return o.default.post("order/comment", t);
        }),
        (e.orderConfirm = function (t, e, i, n) {
          return o.default.post("order/confirm", { cartId: t, new: e, addressId: i, shipping_type: n });
        }),
        (e.orderCoupon = function (t) {
          return o.default.post("v2/order/product_coupon/" + t);
        }),
        (e.orderCreate = function (t, e) {
          return o.default.post("order/create/" + t, e);
        }),
        (e.orderData = function () {
          return o.default.get("order/data");
        }),
        (e.orderDel = function (t) {
          return o.default.post("order/del", { uni: t });
        }),
        (e.orderInvoiceDetail = function (t) {
          return o.default.get("v2/order/invoice_detail/".concat(t));
        }),
        (e.orderInvoiceList = function (t) {
          return o.default.get("v2/order/invoice_list", t);
        }),
        (e.orderOfflinePayType = function () {
          return o.default.get("order/offline/pay/type");
        }),
        (e.orderPay = function (t) {
          return o.default.post("order/pay", t);
        }),
        (e.orderProduct = function (t) {
          return o.default.post("order/product", { unique: t });
        }),
        (e.orderRefundVerify = function (t) {
          return o.default.post("order/refund/verify", t);
        }),
        (e.orderTake = function (t) {
          return o.default.post("order/take", { uni: t });
        }),
        (e.postOrderComputed = function (t, e) {
          return o.default.post("order/computed/" + t, e);
        }),
        (e.postRefundGoods = function (t) {
          return o.default.post("order/refund/cart_info", t);
        }),
        (e.refundExpress = function (t) {
          return o.default.post("order/refund/express", t);
        }),
        (e.refundGoodsList = function (t) {
          return o.default.get("order/refund/cart_info/".concat(t));
        }),
        (e.refundOrderDel = function (t) {
          return o.default.get("order/refund/del/" + t, {});
        }),
        (e.refundOrderDetail = function (t) {
          return o.default.get("order/refund/detail/" + t);
        }),
        (e.returnGoodsSubmit = function (t, e) {
          return o.default.post("order/refund/apply/".concat(t), e);
        }),
        (e.vcartList = function () {
          return o.default.get("v2/cart_list");
        }),
        i("99af");
      var a = n(i("0122")),
        o = n(i("fb81"));
    ...
    "3f51": function (t, e, i) {
      ...
      var o = i("2a39"),
        ...
        k = n(i("47fd")),
        I = n(i("3d2e")),
        E = uni.getSystemInfoSync().statusBarHeight + "px",
        O = getApp(),
        T = {
          components: {
            productConSwiper: h.default,
            couponListWindow: v.default,
            productWindow: f.default,
            userEvaluation: g.default,
            shareRedPackets: m.default,
            kefuIcon: w.default,
            menuIcon: b.default,
            cusPreviewImg: l.default,
            swiperPrevie: p.default,
            parser: k.default,
            homeList: I.default,
          },
          directives: {
          ...
          mixins: [A.default, S.sharePoster],
          data: function () {
            return {
              imgHost: C.HTTP_REQUEST_URL,
              sysHeight: E,
              noGoods: !1,
              showSkeleton: !0,
              isNodes: 0,
          ...
          computed: (0, d.mapGetters)(["isLogin"]),
          watch: {
            isLogin: {
          ...
          onReady: function () {
            this.isNodes++,
              this.$nextTick(function () {
                var t = this,
                  e = new x.default(".copy-data");
                e.on("success", function () {
                  t.$util.Tips({ title: t.$t("复制成功") });
                });
              });
          },
          ...
          methods: {
            ...
            qrR: function (t) {
              (this.$wechat.isWeixin() && "1" == this.shareQrcode) ||
                ((this.PromotionCode = t), (this.followCode = ""));
            },
              ...
              "1" === e.type
                ? uni.navigateTo({
                    url: "/pages/activity/goods_seckill_details/index?id="
                      .concat(e.id, "&time=")
                      .concat(e.time, "&status=1"),
                  })
                : "2" === e.type
                ? uni.navigateTo({
                    url: "/pages/activity/goods_bargain_details/index?id=".concat(e.id, "&bargain=").concat(this.uid),
                  })
                : uni.navigateTo({ url: "/pages/activity/goods_combination_details/index?id=".concat(e.id) });
            },
            ...
            tap: function (t) {
              ...
              this.$set(this, "toView", i),
                ...
                this.$nextTick(function () {
                  e.scrollTop = t > 0 ? n.topArr[t] - O.globalData.navHeight / 2 : n.topArr[t];
                });
            },
            scroll: function (t) {
              ...
              if (
                ...
                for (var n = 0; n < this.topArr.length; n++)
                  if (e < this.topArr[n] - O.globalData.navHeight / 2 + this.heightArr[n]) {
                    this.$set(this, "navActive", n);
                    break;
                  }
            },
            goDetail: function (t) {
              0 != t.activity.length
                ? t.activity && 2 == t.activity.type
                  ? uni.redirectTo({
                      url: "/pages/activity/goods_bargain_details/index?id="
                        .concat(t.activity.id, "&bargain=")
                        .concat(this.uid),
                    })
                  : t.activity && 3 == t.activity.type
                  ? uni.redirectTo({ url: "/pages/activity/goods_combination_details/index?id=".concat(t.activity.id) })
                  : t.activity &&
                    1 == t.activity.type &&
                    uni.redirectTo({
                      url: "/pages/activity/goods_seckill_details/index?id="
                        .concat(t.activity.id, "&time=")
                        .concat(t.activity.time, "&status=1"),
                    })
                : uni.redirectTo({ url: "/pages/goods_details/index?id=" + t.id });
            },
            ...
            ChangeCartNum: function (t) {
              ...
              var i = e.stock || 0,
                n = this.attr.productSelect;
              void 0 === e ||
                (this.storeInfo.limit_num && n.cart_num >= this.storeInfo.limit_num && t) ||
                (t
                  ? (n.cart_num++,
                    n.cart_num > i &&
            ...
            setClientHeight: function () {
              var t = this;
              if (t.good_list.length) {
                var e = uni.createSelectorQuery().in(this).select("#list0");
                e.fields({ size: !0 }, function (e) {
                  t.$set(t, "clientHeight", e.height + 20);
                }).exec();
              }
            },
            getGoodsDetails: function () {
              ...
              uni.showLoading({ title: "加载中", mask: !0 }),
                (0, o.getProductDetail)(e.id)
                  .then(function (i) {
                    uni.hideLoading();
                    for (
                      var n = i.data.storeInfo,
                        a = i.data.good_list || [],
                        o = Math.ceil(a.length / 6),
                        s = new Array(),
                        r = 0;
                      r < o;
                      r++
                    ) {
                      var c = a.slice(6 * r, 6 * r + 6);
                      c.length && s.push({ list: c });
                    }
                    for (var u in (e.$set(e, "storeInfo", n),
                    e.$set(e, "description", n.description),
                    t.description &&
                    ...
                    e.$set(e, "presale_pay_status", i.data.storeInfo.presale_pay_status),
                    e.$set(e, "reply", i.data.reply ? [i.data.reply] : []),
                    e.$set(e, "replyCount", i.data.replyCount),
                    e.$set(e, "replyChance", i.data.replyChance),
                    e.$set(e.attr, "productAttr", i.data.productAttr),
                    e.$set(e, "productValue", i.data.productValue),
                    e.$set(e, "is_vip", i.data.storeInfo.is_vip),
                    e.$set(e.sharePacket, "priceName", i.data.priceName),
                    e.$set(e.sharePacket, "isState", 0 != i.data.priceName),
                    e.$set(e, "systemStore", i.data.system_store),
                    e.$set(e, "storeSelfMention", i.data.store_self_mention),
                    e.$set(e, "good_list", s),
                    n.wechat_code
                      ? e.$set(e, "PromotionCode", n.wechat_code)
                      : (t.codeVal =
                    ...
                    e.$set(e, "activity", i.data.activity ? i.data.activity : []),
                    e.$set(e, "couponList", i.data.coupons),
                    e.$set(e, "routineContact", Number(i.data.routine_contact_type)),
                    uni.setNavigationBarTitle({ title: n.store_name.substring(0, 7) + "..." }),
                    i.data.productValue)) {
                      var d = i.data.productValue[u];
                      e.skuArr.push(d);
                    }
                    t.$set(t, "selectSku", e.skuArr[0]), e.$set(e, "diff", e.$util.$h.Sub(n.price, n.vip_price));
                    var l = [e.$t("商品"), e.$t("详情")];
                    i.data.replyCount && l.splice(1, 0, e.$t("评价")),
                      e.$set(e, "navList", l),
                      e.$set(e, "storeImage", e.storeInfo.image),
                      e.$set(e, "svip_price_open", i.data.svip_price_open),
                      e.isLogin && e.getUserInfo(),
                      t.getImageBase64(),
                      e.isLogin && e.ShareInfo(),
                      t.$nextTick(function () {
                        a.length && e.setClientHeight();
                      }),
                      setTimeout(function () {
                        e.infoScroll();
                      }, 500),
                  ...
                  .catch(function (t) {
                    return uni.hideLoading(), e.$util.Tips({ title: t.toString() }, { tab: 3, url: 1 });
                  });
            },
            infoScroll: function () {
              for (var t = this, e = [], i = [], n = 0; n < t.navList.length; n++) {
                var a = uni.createSelectorQuery().in(this),
                  o = "#past" + n;
                ((!this.replyCount && !t.good_list.length && 1 == n) ||
                  (this.replyCount && !t.good_list.length && 2 == n) ||
                  (!this.replyCount && t.good_list.length && 2 == n)) &&
                  (o = "#past3"),
                  !this.replyCount && t.good_list.length && 1 == n && (o = "#past2"),
                  a.select(o).boundingClientRect(),
                  a.exec(function (n) {
                    var a = n[0].top,
                      o = n[0].height;
                    e.push(a), i.push(o), t.$set(t, "topArr", e), t.$set(t, "heightArr", i);
                  });
              }
            },
            makePhone: function () {
              uni.makePhoneCall({ phoneNumber: this.systemStore.phone });
            },
            ...
            DefaultSelect: function () {
              ...
              for (var n = 0; n < t.length; n++) this.$set(t[n], "index", e[n]);
              var a = this.productValue[e.join(",")];
              a && t.length
                ? (this.$set(this.attr.productSelect, "store_name", this.storeInfo.store_name),
                  this.$set(this.attr.productSelect, "image", a.image),
                  this.$set(this.attr.productSelect, "price", a.price),
                  this.$set(this.attr.productSelect, "stock", a.stock),
                  this.$set(this.attr.productSelect, "unique", a.unique),
                  this.$set(this.attr.productSelect, "cart_num", this.storeInfo.min_qty),
                  this.$set(this, "attrValue", e.join(",")),
                  this.$set(this.attr.productSelect, "vip_price", a.vip_price),
                  this.$set(this, "attrTxt", this.$t("已选择")))
                : !a && t.length
                ? (this.$set(this.attr.productSelect, "store_name", this.storeInfo.store_name),
            ...
            getCouponList: function (t) {
              ...
              (void 0 === t && null === t) || (i.type = t),
                (0, r.getCoupons)(i).then(function (i) {
                  if ((e.$set(e.coupon, "count", i.data.count), void 0 === t || null === t)) {
                    var n = (0, a.default)(e.coupon.count),
                      o = "",
            ...
            setCollect: function () {
              if (!1 === this.isLogin) (0, u.toLogin)();
                ...
                this.storeInfo.userCollect
                  ? (0, o.collectDel)([this.storeInfo.id]).then(function (e) {
                      return (
                        t.$set(t.storeInfo, "userCollect", !t.storeInfo.userCollect), t.$util.Tips({ title: e.msg })
                      );
                    })
                  : (0, o.collectAdd)(this.storeInfo.id).then(function (e) {
                      return (
                        t.$set(t.storeInfo, "userCollect", !t.storeInfo.userCollect), t.$util.Tips({ title: e.msg })
                      );
                    });
            ...
            selecAttr: function () {
              this.$refs.proSwiper.videoIsPause(), this.$set(this.attr, "cartAttr", !0), this.$set(this, "isOpen", !0);
            },
            couponTap: function () {
              !1 === this.isLogin
                ? (0, u.toLogin)()
            ...
            goCart: function () {
              uni.switchTab({ url: "/pages/order_addcart/order_addcart" });
            },
            goCat: function (t) {
              var e = this,
                i = e.productValue[this.attrValue];
              if (
                ((e.currentPage = !1),
                e.attrValue
                  ? (e.attr.cartAttr = !e.isOpen)
                  : e.isOpen
                  ? (e.attr.cartAttr = !0)
                  : (e.attr.cartAttr = !e.attr.cartAttr),
                !0 === e.attr.cartAttr && !1 === e.isOpen)
              )
                return (e.isOpen = !0);
              if (e.attr.productAttr.length && void 0 === i && !0 === e.isOpen)
                return e.$util.Tips({ title: e.$t("产品库存不足，请选择其它属性") });
              if (e.attr.productSelect.cart_num <= 0)
                return (
                  (e.attr.productSelect.cart_num = 1), (e.isOpen = !1), e.$util.Tips({ title: e.$t("请选择数量") })
                );
              var n = {
                productId: e.id,
                cartNum: e.attr.productSelect.cart_num,
                new: void 0 === t ? 0 : 1,
                uniqueId: void 0 !== e.attr.productSelect ? e.attr.productSelect.unique : "",
                virtual_type: e.storeInfo.virtual_type,
              };
              (0, o.postCartAdd)(n)
                .then(function (i) {
                  (e.isOpen = !1),
                    (e.attr.cartAttr = !1),
                    t
                      ? uni.navigateTo({ url: "/pages/goods/order_confirm/index?new=1&cartId=" + i.data.cartId })
                      : e.$util.Tips({
                          title: e.$t("添加成功"),
                          success: function () {
                            e.getCartCount(!0);
                ...
                .catch(function (t) {
                  return (e.isOpen = !1), e.$util.Tips({ title: t });
                });
            },
            getCartCount: function (t) {
              var e = this,
                ...
                n = i.isLogin;
              n &&
                (0, c.getCartCounts)().then(function (n) {
                  (i.CartCount = n.data.count),
            ...
            listenerActionSheet: function () {
              (this.currentPage = !1), this.$wechat.isWeixin() && (this.weixinStatus = !0), (this.posters = !0);
            },
            ...
            ShareInfo: function () {
              ...
              this.$wechat.isWeixin() &&
                (0, s.getUserInfo)().then(function (n) {
                  i =
                    -1 === i.indexOf("?")
                      ? i + "?spread=" + n.data.uid
                      : (0, y.updateURLParameter)(i, "spread", n.data.uid);
                  var a = { desc: e.store_info, title: e.store_name, link: i, imgUrl: e.image };
                  t.$wechat
                    .wechatEvevt(
                      [
    ...
    "475f": function (t, e, i) {
      ...
      a("745adc4c", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    5072: function (t, e, i) {
      "use strict";
      i.r(e);
      ...
      i("5952");
      var s = i("f0c5"),
        r = Object(s["a"])(a["default"], n["b"], n["c"], !1, null, "fb4784ca", null, !1, n["a"], void 0);
      e["default"] = r.exports;
    },
    5952: function (t, e, i) {
      "use strict";
    ...
    "5bb2": function (t, e, i) {
      ...
      var a = n(i("f07e")),
        o = n(i("c964")),
        s = i("4e39"),
        r = (i("2a39"), i("84d8"), n(i("c786"))),
        c = uni.getSystemInfoSync().statusBarHeight + "px",
        u = {
          data: function () {
            return {
              codeShow: !1,
          ...
          methods: {
            ...
            getImageBase64: function () {
              var t = this,
                e = this;
              (0, s.imageBase64)(e.storeImage, this.storeInfo.wechat_code)
                .then(function (i) {
                  (e.storeImageBase64 = i.data.image), t.storeInfo.wechat_code && (e.PromotionCode = i.data.code);
                })
                .catch(function () {});
            },
            initPoster: function (t) {
              var e = this;
              uni.getImageInfo({
                src: e.PromotionCode,
                success: function () {
                  "" == t[2]
                    ? e.downloadFilePromotionCode(function (i) {
                        if (((t[2] = i), "" == t[2])) return e.$util.Tips({ title: r.default.t("海报二维码生成失败") });
                        e.$util.PosterCanvas(
                          t,
                          e.storeInfo.store_name,
                          e.storeInfo.price,
                          e.storeInfo.ot_price,
                          function (t) {
                            e.$set(e, "posterImage", t),
                              e.$set(e, "posterImageStatus", !0),
                              e.$set(e, "canvasStatus", !1),
                              e.$set(e, "actionSheetHidden", !e.actionSheetHidden);
                          }
                        );
                      })
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          if (
                            ((i = e),
                            (i.posters = !1),
                            i.$set(i, "canvasStatus", !0),
                            (n = [i.posterbackgd, i.storeImageBase64, i.PromotionCode]),
                            i.storeImageBase64)
                          ) {
                            t.next = 6;
                            break;
                          }
                          return t.abrupt("return", i.$util.Tips({ title: r.default.t("正在下载海报,请稍后再试") }));
                        case 6:
                          i.initPoster(n);
                        case 7:
                        case "end":
            ...
            downloadFilestoreImage: function () {
              var t = this;
              uni.downloadFile({
                url: t.setDomain(t.storeInfo.image),
                success: function (e) {
                  (t.storeImage = e.tempFilePath), (t.storeImageBase64 = e.tempFilePath);
                },
                fail: function () {
                  return t.$util.Tips({ title: "" });
                },
              });
            },
            downloadFilePromotionCode: function (t) {},
          },
        };
      e.sharePoster = u;
    },
      ...
      var n = {
        ...
        data: function () {
          return {
            ...
            menuButton: {},
            iconList: [
              { name: this.$t("首页"), iconName: "icon-shouye8", path: "/pages/index/index", jumpType: 1 },
              {
                name: this.$t("购物车"),
              ...
              { name: this.$t("搜索"), iconName: "icon-sousuo6", path: "/pages/goods/goods_search/index", jumpType: 0 },
              {
                name: this.$t("我的收藏"),
              ...
              { name: this.$t("个人中心"), iconName: "icon-yonghu1", path: "/pages/user/index", jumpType: 1 },
            ],
          };
        },
        props: { showMenuIcon: { type: Boolean, default: !1 }, opacity: { type: Number, default: 1 } },
        watch: {
          showMenuIcon: function (t) {
            this.Active = t;
          },
          opacity: function (t) {
            this.text_opacity = t;
        ...
        mounted: function () {
          ...
          (this.returnShow = 1 !== t.length), this.$nextTick(function () {});
        },
        methods: {
          open: function () {
            (this.Active = !this.Active), this.Active && this.$emit("open", !0);
          },
          returns: function () {
            uni.navigateBack();
          },
          jumpUrl: function (t, e) {
            (1 === e ? uni.switchTab : uni.navigateTo)({ url: t });
          },
        },
      };
      e.default = n;
    ...
    6789: function (t, e, i) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("e900dd08", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "68bd": function (t, e, i) {
      "use strict";
      i.r(e);
    ...
    "78cb": function (t, e, i) {
      ...
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* crmeb颜色变量 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.home[data-v-732b5737]{top:%?20?%!important}.home.opacity[data-v-732b5737]{background:#fff;border:1px solid #d7d7d7}.home[data-v-732b5737]{color:#333;position:fixed;height:%?62?%;z-index:99;left:%?33?%;border:1px solid #d7d7d7;background:hsla(0,0%,100%,.8);border-radius:%?30?%;display:flex;align-items:center;justify-content:space-around}.home .opacity[data-v-732b5737]{color:#000}.home .icon-gengduo4[data-v-732b5737],\n.home .icon-guanbi5[data-v-732b5737]{position:absolute;width:%?40?%;font-weight:700}.home .icon-xiangzuo[data-v-732b5737]{font-weight:700;line-height:%?28?%}.home .icon-gengduo4[data-v-732b5737]{font-size:%?28?%;text-align:center}.home .animation-box[data-v-732b5737]{position:relative;width:%?40?%;height:%?28?%}.icon-guanbi5[data-v-732b5737]{font-size:%?28?%;text-align:center}.home .homeCon[data-v-732b5737]{display:flex;flex-direction:column;font-size:%?26?%;padding:%?4?%;opacity:0;border:1px solid #f2f2f2}.home .homeCon[data-v-732b5737]::before{content:"";width:0;height:0;border-left:%?15?% solid transparent;border-right:%?15?% solid transparent;border-bottom:%?17?% solid #fff;position:absolute;top:%?-15?%;right:%?66?%;border-bottom-color:#f2f2f2}.home .homeCon[data-v-732b5737]::after{content:"";width:0;height:0;border-left:%?15?% solid transparent;border-right:%?15?% solid transparent;border-bottom:%?17?% solid #fff;position:absolute;top:%?-13?%;right:%?66?%}.home .homeCon .homeCon-box[data-v-732b5737]{display:flex;align-items:center;flex-wrap:nowrap;width:100%;padding:%?15?% %?20?%}.home .homeCon .homeCon-box .text[data-v-732b5737]{display:flex;flex-wrap:nowrap}.home .homeCon .iconfont[data-v-732b5737]{display:flex;align-items:center;padding:%?5?% %?3?%;margin-right:%?5?%}.home .homeCon .homeCon-box[data-v-732b5737]:nth-child(even){border-top:1px solid #f2f2f2;border-bottom:1px solid #f2f2f2}.home .homeCon.active[data-v-732b5737]{position:absolute;opacity:1;top:%?75?%;-webkit-animation:bounceInLeft .5s cubic-bezier(.215,.31,.655,1);animation:bounceInLeft .5s cubic-bezier(.215,.31,.655,1);width:-webkit-max-content;width:max-content;display:flex;justify-content:center;align-items:center;border-radius:%?10?%;color:#333;background:#fff!important;box-shadow:%?0?% %?3?% %?10?% %?2?% rgba(0,0,0,.03)}.home .line[data-v-732b5737]{width:%?2?%;height:%?26?%;margin:0 %?18?% 0 %?16?%;background:#fff}.home .line.opacity[data-v-732b5737]{color:#050505;background-color:#050505}.home .icon-xiangzuo[data-v-732b5737]{font-size:%?28?%}.fade-enter-active[data-v-732b5737],\n.fade-leave-active[data-v-732b5737]{transition:opacity .3s}.fade-enter[data-v-732b5737],\n.fade-leave-to[data-v-732b5737]{opacity:0}.p10[data-v-732b5737]{padding:0 %?25?%}.p20[data-v-732b5737]{padding:0 %?40?%}',
          "",
        ]),
        (t.exports = e);
    },
    "79d4": function (t, e, i) {
      ...
      i("1d3c");
      var s = i("f0c5"),
        r = Object(s["a"])(a["default"], n["b"], n["c"], !1, null, "1199d7db", null, !1, n["a"], void 0);
      e["default"] = r.exports;
    },
    "7c33": function (t, e, i) {
      "use strict";
          ...
          return i(
            ...
            [
              i(
                "v-uni-view",
                {
                  staticClass: "home acea-row row-center-wrapper",
                  class: [t.returnShow ? "p10" : "p20", t.text_opacity >= 1 ? "opacity" : ""],
                  style: { marginTop: t.menuButton.top + "px", width: t.menuButton.width + "px" },
                  attrs: { id: "home" },
                },
                [
                  t.returnShow
                    ? i("v-uni-view", {
                        ...
                        class: t.text_opacity >= 1 ? "opacity" : "",
                        on: {
                          click: function (e) {
                      ...
                      i(
                        ...
                        [
                          t.Active
                            ? t._e()
                            : i("v-uni-view", {
                                staticClass: "iconfont icon-gengduo4",
                                class: t.text_opacity >= 1 ? "opacity" : "",
                                on: {
                                  click: function (e) {
                  ...
                  t.Active
                    ? i(
                        "v-uni-view",
                        {
                          staticClass: "homeCon bg-color",
                          class: !0 === t.Active ? "active" : "",
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)), t.open.apply(void 0, arguments);
                            },
                        ...
                        t._l(t.iconList, function (e, n) {
                          return i(
                            "v-uni-view",
                            {
                              key: n,
                              staticClass: "homeCon-box",
                              on: {
                                click: function (i) {
                                  (arguments[0] = i = t.$handleEvent(i)), t.jumpUrl(e.path, e.jumpType);
                                },
                              },
                            },
                            [
                              i("v-uni-text", { staticClass: "iconfont", class: e.iconName }),
                              i("v-uni-text", { staticClass: "text" }, [t._v(t._s(e.name))]),
                            ],
                            1
                          );
                        }),
    ...
    a321: function (t, e, i) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("2ce43049", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    aa11: function (t, e, i) {
      "use strict";
      i("7a82"), Object.defineProperty(e, "__esModule", { value: !0 }), (e.default = void 0), i("a9e3");
      var n = i("5743"),
        ...
        o = {
          props: {
            openType: { type: Number, default: 0 },
            coupon: {
              type: Object,
              default: function () {
                return {};
          ...
          data: function () {
            return { imgHost: a.HTTP_REQUEST_URL, type: 0 };
          },
          methods: {
            close: function () {
              this.$emit("ChangCouponsClone"), (this.type = 0);
            },
            getCouponUser: function (t, e) {
              var i = this,
                a = i.coupon.list;
              if (a[t].is_use >= a[t].receive_limit && 0 == this.openType) return !0;
              switch (this.openType) {
                case 0:
                  (0, n.setCouponReceive)(e)
                    .then(function (e) {
                      i.$emit("ChangCouponsUseState", t), i.$util.Tips({ title: "领取成功" });
                    })
                    .catch(function (t) {
                  ...
                  break;
                case 1:
                  i.$emit("ChangCoupons", t);
                  break;
              }
            },
            setType: function (t) {
              (this.type = t), this.$emit("tabCouponType", t);
            },
          },
        };
      e.default = o;
    ...
    abac: function (t, e, i) {
      ...
      var n = { zbCode: i("92ed").default },
        a = function () {
          ...
          return n(
            "v-uni-view",
            { staticClass: "product-con", style: t.colorStyle },
            [
              n(
                "v-uni-view",
                ...
                [
                        ...
                        [
                          n(
                            "v-uni-view",
                            {
                              ...
                              style: { paddingRight: t.navbarRight - 20 + "px" },
                            },
                            [
                              n(
                                "v-uni-view",
                                ...
                                t._l(t.navList, function (e, i) {
                                  return n(
                                    "v-uni-view",
                                    {
                                      key: i,
                                      staticClass: "item",
                                      class: t.navActive === i ? "on" : "",
                                      on: {
                                        click: function (e) {
                                          (arguments[0] = e = t.$handleEvent(e)), t.tap(i);
                                        },
                                      },
                                    },
                                    [t._v(t._s(e))]
                  ...
                  n(
                    "v-uni-view",
                    {
                      staticClass: "home right acea-row row-center-wrapper",
                      class: [t.opacity > 0.5 ? "on" : ""],
                      style: { top: t.homeTop + "rpx" },
                      attrs: { id: "home" },
                    },
                        ...
                        [
                          n(
                            ...
                            [
                              n("productConSwiper", {
                                ref: "proSwiper",
                                attrs: { imgUrls: t.storeInfo.slider_image, videoline: t.storeInfo.video_link },
                                on: {
                                  videoPause: function (e) {
                                    (arguments[0] = e = t.$handleEvent(e)), t.videoPause.apply(void 0, arguments);
                                  },
                                  showSwiperImg: function (e) {
                                    (arguments[0] = e = t.$handleEvent(e)), t.showSwiperImg.apply(void 0, arguments);
                                  },
                                },
                              }),
                              n(
                                ...
                                [
                                    ...
                                    [
                                      n(
                                        ...
                                        [
                                          ...
                                          t.storeInfo.spec_type ? n("v-uni-text", [t._v(t._s(t.$t("起")))]) : t._e(),
                                          t.storeInfo.vip_price &&
                                          t.storeInfo.vip_price > 0 &&
                                          1 == t.storeInfo.is_vip &&
                                          1 == t.svip_price_open
                                            ? n("v-uni-text", { staticClass: "vip-money" }, [
                                                t._v(t._s(t.$t("￥")) + t._s(t.storeInfo.vip_price)),
                                              ])
                                            : t._e(),
                                          t.storeInfo.vip_price &&
                                          t.storeInfo.vip_price > 0 &&
                                        ...
                                        on: {
                                          click: function (e) {
                                            (arguments[0] = e = t.$handleEvent(e)),
                                              t.listenerActionSheet.apply(void 0, arguments);
                                          },
                                        },
                                      }),
                                    ],
                                  ...
                                  n("v-uni-view", {
                                    ...
                                    domProps: { textContent: t._s(t.storeInfo.store_name || "") },
                                  }),
                                  t.storeInfo.limit_type > 0
                                    ? n(
                                        "v-uni-view",
                                        { staticClass: "limit_good" },
                                        [
                                          t._v(
                                            t._s(1 == t.storeInfo.limit_type ? t.$t("单次限购") : t.$t("永久限购")) +
                                              t._s(t.storeInfo.limit_num) +
                                              t._s(t.$t(t.storeInfo.unit_name))
                                          ),
                                          t.storeInfo.limit_type > 0 && t.storeInfo.min_qty > 1
                                            ? n("v-uni-text", { staticClass: "line" }, [t._v("|")])
                                            : t._e(),
                                          t.storeInfo.min_qty > 1
                                            ? n("v-uni-text", [
                                                t._v(
                                                  t._s(t.$t("起购")) + t._s(t.storeInfo.min_qty + t.storeInfo.unit_name)
                                                ),
                                              ])
                                            : t._e(),
                                        ],
                                  ...
                                  n(
                                    "v-uni-view",
                                    {
                                      staticClass: "label acea-row row-between-wrapper",
                                      staticStyle: { "padding-bottom": "20rpx" },
                                    },
                                    [
                                      n("v-uni-view", { staticClass: "delete-line" }, [
                                        t._v(
                                          t._s(t.$t("划线价")) +
                                            " : " +
                                            t._s(t.$t("￥")) +
                                            t._s(t.storeInfo.ot_price || 0)
                                        ),
                                      ]),
                                      n("v-uni-view", {}, [
                                        t._v(
                                  ...
                                  !t.is_money_level && t.storeInfo.vip_price && t.storeInfo.is_vip
                                    ? n(
                                        "v-uni-view",
                                        { staticClass: "svip acea-row row-between-wrapper" },
                                        [
                                          n("v-uni-view", {}, [
                                            t._v(t._s(t.$t("开通“超级会员”立省")) + t._s(t.diff) + t._s(t.$t("元"))),
                                          ]),
                                          n(
                                            "v-uni-navigator",
                                            { attrs: { url: "/pages/annex/vip_paid/index" } },
                                            [
                                              t._v(t._s(t.$t("立即开通"))),
                                              n("v-uni-text", { staticClass: "iconfont icon-jiantou" }),
                                            ],
                                            1
                                          ),
                                        ],
                                  ...
                                  t.storeInfo.presale
                                    ? n(
                                        "v-uni-view",
                                        { staticClass: "presell_count" },
                                        [
                                          n(
                                            "v-uni-view",
                                            [
                                              n("v-uni-view", [t._v(t._s(t.$t("预售活动时间")) + "：")]),
                                              t.storeInfo.presale_start_time && t.storeInfo.presale_end_time
                                                ? n(
                                                    "v-uni-view",
                                                    { staticClass: "presell_time" },
                                                    [
                                                      n("v-uni-view", { staticClass: "iconfont icon-shijian1" }),
                                                      t._v(t._s(t.storeInfo.presale_start_time)),
                                                      n("span", { staticClass: "area_line" }, [t._v("~")]),
                                                      t._v(t._s(t.storeInfo.presale_end_time)),
                                                    ],
                                                    1
                                                  )
                                                : t._e(),
                                  ...
                                  t.couponList.length
                                    ? n(
                                        "v-uni-view",
                                        {
                                          staticClass: "coupon acea-row row-between-wrapper",
                                          staticStyle: { "margin-top": "0rpx" },
                                          on: {
                                            click: function (e) {
                                              (arguments[0] = e = t.$handleEvent(e)),
                                                t.couponTap.apply(void 0, arguments);
                                            },
                                          },
                                        },
                                        [
                                          n(
                                            "v-uni-view",
                                            { staticClass: "hide line1 acea-row" },
                                            [
                                              t._v(t._s(t.$t("优惠券")) + "："),
                                              t._l(t.couponList, function (e, i) {
                                                return [
                                                  i < 2
                                                    ? n("v-uni-view", { key: i, staticClass: "activity" }, [
                                                        t._v(
                                                          t._s(t.$t("满")) +
                                                            " " +
                                                            t._s(e.use_min_price) +
                                                            " " +
                                                            t._s(t.$t("减")) +
                                                            " " +
                                                            t._s(e.coupon_price)
                                  ...
                                  t.activity.length
                                    ? n(
                                        ...
                                        [
                                          n(
                                            "v-uni-view",
                                            { staticClass: "line1 acea-row" },
                                            [
                                              n("v-uni-text", { staticClass: "coupon-title" }, [
                                                t._v(t._s(t.$t("活动")) + "："),
                                              ]),
                                              t._l(t.activity, function (e, i) {
                                                return n(
                                                  "v-uni-view",
                                                  {
                                                    key: i,
                                                    on: {
                                                      click: function (i) {
                                                        (arguments[0] = i = t.$handleEvent(i)), t.goActivity(e);
                                                      },
                                                    },
                                                  },
                                                  [
                                                    "1" === e.type && t.$permission("seckill")
                                                      ? n(
                                                          "v-uni-view",
                                                          {
                                                            class:
                                                          ...
                                                          [
                                                            n("v-uni-text", {
                                                              staticClass: "iconfonts iconfont icon-pintuan",
                                                            }),
                                                            n("v-uni-text", { staticClass: "activity_title" }, [
                                                              t._v(t._s(t.$t("参与秒杀"))),
                                                            ]),
                                                          ],
                                                          1
                                                    ...
                                                    "2" === e.type && t.$permission("bargain")
                                                      ? n(
                                                          ...
                                                          [
                                                            n("v-uni-text", {
                                                              staticClass: "iconfonts iconfont icon-shenhezhong",
                                                            }),
                                                            n("v-uni-text", { staticClass: "activity_title" }, [
                                                              t._v(t._s(t.$t("参与砍价"))),
                                                            ]),
                                                      ...
                                                      : t._e(),
                                                    "3" === e.type && t.$permission("combination")
                                                      ? n(
                                                          "v-uni-view",
                                                          {
                                                            class:
                                                          ...
                                                          [
                                                            n("v-uni-text", {
                                                              staticClass: "iconfonts iconfont icon-kanjia",
                                                            }),
                                                            n("v-uni-text", { staticClass: "activity_title" }, [
                                                              t._v(t._s(t.$t("参与拼团"))),
                                                            ]),
                                      ...
                                      n(
                                        ...
                                        [
                                          n(
                                            ...
                                            [
                                              n("v-uni-view", { staticClass: "attr-txt" }, [
                                                t._v(t._s(t.attrTxt) + "："),
                                              ]),
                                              n(
                                                "v-uni-view",
                                      ...
                                      t.skuArr.length > 1
                                        ? n(
                                            "v-uni-view",
                                            {
                                              ...
                                              staticStyle: { "margin-top": "7px", "padding-left": "60px" },
                                            },
                                            [
                                              n(
                                                "v-uni-view",
                                              ...
                                              n("v-uni-view", { staticClass: "switchTxt" }, [
                                                t._v(
                                                  t._s(t.$t("共")) +
                                                    t._s(t.skuArr.length) +
                                                    " " +
                                                    t._s(t.$t("种规格可选"))
                                                ),
                                              ]),
                          ...
                          t.replyCount
                            ? n(
                                "v-uni-view",
                                { staticClass: "userEvaluation", attrs: { id: "past1" } },
                                [
                                  n(
                                    "v-uni-view",
                                    { staticClass: "title acea-row row-between-wrapper" },
                                    [
                                      n("v-uni-view", [t._v(t._s(t.$t("用户评价")) + "(" + t._s(t.replyCount) + ")")]),
                                      n(
                                        "v-uni-navigator",
                                        {
                                          staticClass: "praise",
                                          attrs: {
                                            "hover-class": "none",
                                            url: "/pages/goods/goods_comment_list/index?product_id=" + t.id,
                                          },
                                        },
                                        [
                                          n("v-uni-text", { staticClass: "font-num" }, [
                                            t._v(t._s(t.replyChance) + "%"),
                                          ]),
                                          t._v(t._s(t.$t("好评率"))),
                                          n("v-uni-text", { staticClass: "iconfont icon-jiantou" }),
                                        ],
                                  ...
                                  t.replyCount ? [n("userEvaluation", { attrs: { reply: t.reply } })] : t._e(),
                                ],
                                2
                              )
                            : t._e(),
                          t.good_list.length
                            ? n(
                                "v-uni-view",
                                { staticClass: "superior", attrs: { id: "past2" } },
                                [
                                  n(
                                    "v-uni-view",
                                    ...
                                    [
                                      n(
                                        "v-uni-view",
                                        { staticClass: "lingw acea-row row-center-wrapper" },
                                        [n("v-uni-view", { staticClass: "lingn" })],
                                        1
                                      ),
                                      n("v-uni-view", { staticClass: "titleTxt" }, [t._v(t._s(t.$t("优品推荐")))]),
                                      n(
                                        "v-uni-view",
                                        { staticClass: "lingw acea-row row-center-wrapper" },
                                        [n("v-uni-view", { staticClass: "lingn" })],
                                  ...
                                  n(
                                    "v-uni-view",
                                    { staticClass: "slider-banner banner" },
                                    [
                                      n(
                                        "v-uni-swiper",
                                        {
                                          style: "height:" + t.clientHeight + "px",
                                          attrs: {
                                            "indicator-dots": "true",
                                            autoplay: t.autoplay,
                                            circular: t.circular,
                                        ...
                                        t._l(t.good_list, function (e, i) {
                                          return n(
                                            ...
                                            [
                                              n(
                                                "v-uni-view",
                                                { staticClass: "list acea-row row-middle", attrs: { id: "list" + i } },
                                                  ...
                                                  return n(
                                                    ...
                                                    [
                                                      n(
                                                        ...
                                                        { staticClass: "pictrue" },
                                                        [
                                                          n("v-uni-image", { attrs: { src: e.image } }),
                                                          e.activity &&
                                                          "1" === e.activity.type &&
                                                          t.$permission("seckill")
                                                            ? n(
                                                                "span",
                                                      ...
                                                      n("v-uni-view", { staticClass: "name line1" }, [
                                                        t._v(t._s(e.store_name)),
                                                      ]),
                                                      n("v-uni-view", { staticClass: "money font-color" }, [
                          ...
                          n(
                            "v-uni-view",
                            { staticClass: "product-intro", attrs: { id: "past3" } },
                            [
                              n("v-uni-view", { staticClass: "title" }, [t._v(t._s(t.$t("产品介绍")))]),
                              n(
                                "v-uni-view",
                                { staticClass: "conter" },
                                [
                                  n("parser", {
                                    ref: "article",
                                    attrs: { html: t.description, "tag-style": t.tagStyle },
                                  }),
                                ],
                                1
                              ),
                          ...
                          n("v-uni-view", { staticClass: "uni-p-b-98" }),
                        ],
                        1
                      ),
                    ],
                  ...
                  n(
                    "v-uni-view",
                    { staticClass: "footer acea-row row-between-wrapper", class: { eject: t.storeInfo.id } },
                    [
                      n(
                        "v-uni-navigator",
                        {
                        ...
                        [
                          n("v-uni-view", { staticClass: "iconfont icon-shouye6" }),
                          n("v-uni-view", { staticClass: "p_center" }, [t._v(t._s(t.$t("首页")))]),
                        ],
                        1
                      ),
                      n(
                        "v-uni-view",
                        {
                          ...
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)), t.setCollect.apply(void 0, arguments);
                            },
                          },
                        },
                        [
                          t.storeInfo.userCollect
                            ? n("v-uni-view", { staticClass: "iconfont icon-shoucang1" })
                            : n("v-uni-view", { staticClass: "iconfont icon-shoucang" }),
                          n("v-uni-view", { staticClass: "p_center" }, [t._v(t._s(t.$t("收藏")))]),
                        ],
                        1
                      ),
                      n(
                        "v-uni-view",
                        {
                          staticClass: "animated item",
                          class: 1 == t.animated ? "bounceIn" : "",
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)), t.goCart.apply(void 0, arguments);
                            },
                          },
                        },
                        [
                          n(
                            ...
                            [
                              parseFloat(t.CartCount) > 0
                                ? n("v-uni-text", { staticClass: "num bg-color" }, [t._v(t._s(t.CartCount || 0))])
                                : t._e(),
                            ],
                            1
                          ),
                          n("v-uni-view", { staticClass: "p_center" }, [t._v(t._s(t.$t("购物车")))]),
                        ],
                        1
                      ),
                      t.noGoods
                            ...
                            [
                              n(
                                ...
                                [
                                  n(
                                    "v-uni-form",
                                    { staticClass: "bnts bg-color-hui" },
                                    [
                                      n(
                                        "v-uni-button",
                                        { staticClass: "bnts bg-color-hui", attrs: { "form-type": "submit" } },
                                        [t._v(t._s(t.$t("暂无产品")))]
                                      ),
                                    ],
                                    1
                            ...
                            [
                              t.storeInfo.presale
                                              ...
                                              n(
                                                ...
                                                [
                                                  n(
                                                    ...
                                                    {
                                                      staticClass: "bnts bg-color-hui",
                                                      attrs: { "form-type": "submit" },
                                                    },
                                                    [
                                                      t._v(
                                                        t._s(
                                                          1 === t.presale_pay_status ? t.$t("未开始") : t.$t("已结束")
                                                        )
                                                      ),
                                                    ]
                                                  ),
                                              ...
                                              n(
                                                "v-uni-form",
                                                {
                                                  ...
                                                  on: {
                                                    submit: function (e) {
                                                      (arguments[0] = e = t.$handleEvent(e)),
                                                        t.goBuy.apply(void 0, arguments);
                                                    },
                                                  },
                                                },
                                                [
                                                  n(
                                                    "v-uni-button",
                                                    { staticClass: "bnts", attrs: { "form-type": "submit" } },
                                                    [t._v(t._s(t.$t("立即购买")))]
                                                  ),
                                                ],
                                                1
                                ...
                                : n(
                                    "v-uni-view",
                                    [
                                      t.attr.productSelect.stock <= 0
                                        ? n(
                                            "v-uni-view",
                                            {
                                              staticClass: "bnt acea-row",
                                              class: t.storeInfo.cart_button ? "" : "virbnt",
                                            },
                                            [
                                              t.storeInfo.cart_button
                                                ? n(
                                                    "v-uni-form",
                                                    {
                                                      staticClass: "joinCart bnts",
                                                      class: t.storeInfo.cart_button ? "" : "virbnt",
                                                      on: {
                                                        submit: function (e) {
                                                          (arguments[0] = e = t.$handleEvent(e)),
                                                            t.joinCart.apply(void 0, arguments);
                                                        },
                                                      },
                                                    },
                                                    [
                                              ...
                                              n(
                                                "v-uni-form",
                                                { staticClass: "buy bnts bg-color-hui" },
                                                [
                                                  n(
                                                    "v-uni-button",
                                                    {
                  ...
                  n("shareRedPackets", {
                    attrs: { sharePacket: t.sharePacket, showAnimate: t.showAnimate },
                    on: {
                      ...
                      closeChange: function (e) {
                        (arguments[0] = e = t.$handleEvent(e)), t.closeChange.apply(void 0, arguments);
                      },
                      boxStatus: function (e) {
                        (arguments[0] = e = t.$handleEvent(e)), t.boxStatus.apply(void 0, arguments);
                      },
                    },
                  }),
                  n("productWindow", {
                    attrs: {
                      ...
                      isShow: 1,
                      iSplus: 1,
                      limitNum: t.storeInfo.limit_num,
                      minQty: t.storeInfo.min_qty,
                      unitName: t.storeInfo.unit_name,
                      id: "product-window",
                      is_vip: t.is_vip,
                      is_virtual: t.storeInfo.is_virtual,
                    },
                    on: {
                      myevent: function (e) {
                  ...
                  n("swiperPrevie", { ref: "cusSwiperImg", attrs: { list: t.storeInfo.slider_image } }),
                  t.coupon
                    ? n("couponListWindow", {
                        attrs: { coupon: t.coupon },
                        on: {
                          ChangCouponsClone: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.ChangCouponsClone.apply(void 0, arguments);
                          },
                          ChangCoupons: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.ChangCoupons.apply(void 0, arguments);
                          },
                          ChangCouponsUseState: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.ChangCouponsUseState.apply(void 0, arguments);
                          },
                          tabCouponType: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.tabCouponType.apply(void 0, arguments);
                          },
                        },
                      })
                    : t._e(),
                  n(
                    "v-uni-view",
                    { staticClass: "generate-posters acea-row row-middle", class: t.posters ? "on" : "" },
                    [
                      !0 === t.weixinStatus
                        ? n(
                            "v-uni-button",
                            {
                              ...
                              on: {
                                click: function (e) {
                                  (arguments[0] = e = t.$handleEvent(e)), (t.H5ShareBox = !0);
                                },
                              },
                            },
                            [
                              n("v-uni-view", { staticClass: "iconfont icon-weixin3" }),
                              n("v-uni-view", {}, [t._v(t._s(t.$t("发送给朋友")))]),
                            ],
                            1
                          )
                        : t._e(),
                      "" != t.storeInfo.command_word
                        ? n(
                            "div",
                            {
                              staticClass: "item copy-data",
                              attrs: { "data-clipboard-text": t.storeInfo.command_word },
                            },
                            [
                              n("v-uni-view", { staticClass: "iconfont icon-fuzhikouling" }),
                              n("v-uni-text", [t._v(t._s(t.$t("复制口令")))]),
                            ],
                            1
                          )
                        : t._e(),
                      n(
                        "v-uni-button",
                        {
                          ...
                          on: {
                            click: function (e) {
                              (arguments[0] = e = t.$handleEvent(e)), t.goPoster.apply(void 0, arguments);
                            },
                          },
                        },
                        [
                          n("v-uni-view", { staticClass: "iconfont icon-haibao" }),
                          n("v-uni-view", {}, [t._v(t._s(t.$t("生成海报")))]),
                        ],
                        1
                      ),
                    ],
                  ...
                  t.posters
                    ? n("v-uni-view", {
                        ...
                        on: {
                          click: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.listenerActionClose.apply(void 0, arguments);
                          },
                        },
                      })
                    : t._e(),
                    ...
                    ? n(
                        ...
                        [
                          n("v-uni-image", {
                            ...
                            on: {
                              click: function (e) {
                                (arguments[0] = e = t.$handleEvent(e)), t.posterImageClose.apply(void 0, arguments);
                              },
                            },
                          }),
                          n("v-uni-image", { staticClass: "poster-img", attrs: { src: t.posterImage } }),
                          n("v-uni-view", { staticClass: "keep" }, [t._v(t._s(t.$t("长按图片可以保存到手机")))]),
                        ],
                        1
                      )
                    : t._e(),
                  t.posterImageStatus ? n("v-uni-view", { staticClass: "mask" }) : t._e(),
                  t.canvasStatus
                    ? n("v-uni-canvas", { staticClass: "canvas", attrs: { "canvas-id": "myCanvas" } })
                    : t._e(),
                  t.H5ShareBox
                    ? n(
                        "v-uni-view",
                        ...
                        [
                          n("v-uni-image", {
                            attrs: { src: t.imgHost + "/statics/images/share-info.png" },
                            on: {
                              click: function (e) {
                                (arguments[0] = e = t.$handleEvent(e)), (t.H5ShareBox = !1);
                              },
                            },
                          }),
                        ],
                  ...
                  n("kefuIcon", {
                    attrs: {
                      ids: parseInt(t.id),
                      routineContact: t.routineContact,
    ...
    c120: function (t, e, i) {
      ...
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* crmeb颜色变量 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.orderCou[data-v-1199d7db]{position:absolute;right:%?20?%;top:50%;margin-top:%?-20?%}.orderCou .iconfont[data-v-1199d7db]{font-size:%?40?%}.orderCou .svip[data-v-1199d7db]{color:#edbb75}.coupon-list .item .text[data-v-1199d7db]{position:relative}.coupon-list .item .text .condition.order[data-v-1199d7db]{width:%?350?%}.coupon-list-window .coupon-list .text .condition .pic[data-v-1199d7db]{width:%?30?%;height:%?30?%;margin-right:%?10?%;vertical-align:middle}.coupon-list-window .coupon-list .text .condition .name[data-v-1199d7db]{vertical-align:middle;font-size:%?26?%;font-weight:500}.coupon-list-window[data-v-1199d7db]{position:fixed;bottom:0;left:0;width:100%;background-color:#fff;border-radius:%?16?% %?16?% 0 0;z-index:999;-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0);transition:all .3s cubic-bezier(.25,.5,.5,.9)}.coupon-list-window.on[data-v-1199d7db]{-webkit-transform:translateZ(0);transform:translateZ(0)}.coupon-list-window .title[data-v-1199d7db]{height:%?124?%;width:100%;text-align:center;line-height:%?124?%;font-size:%?32?%;font-weight:700;position:relative}.coupon-list-window .title .iconfont[data-v-1199d7db]{position:absolute;right:%?30?%;top:50%;-webkit-transform:translateY(-50%);transform:translateY(-50%);font-size:%?35?%;color:#8a8a8a;font-weight:400}.coupon-list-window .coupon-list[data-v-1199d7db]{margin:0 0 %?50?% 0;height:%?721?%;padding-top:%?28?%;overflow:auto}.coupon-list-window .pictrue[data-v-1199d7db]{width:%?414?%;height:%?336?%;margin:%?192?% auto %?243?% auto}.coupon-list-window .pictrue uni-image[data-v-1199d7db]{width:100%;height:100%}.pic-num[data-v-1199d7db]{color:#fff;font-size:%?24?%}.line-title[data-v-1199d7db]{width:%?70?%;height:%?32?%!important;padding:0 %?10?%;line-height:%?30?%;text-align:center;background:var(--view-minorColorT);border:1px solid var(--view-theme);opacity:1;border-radius:%?20?%;font-size:%?18?%;color:var(--view-theme);margin-right:%?12?%;box-sizing:border-box}.line-title.gray[data-v-1199d7db]{border-color:#c1c1c1!important;color:#c1c1c1!important;background-color:#f7f7f7!important}.nav[data-v-1199d7db]{position:absolute;top:0;left:0;width:100%;height:%?106?%;border-bottom:%?2?% solid #f5f5f5;border-top-left-radius:%?16?%;border-top-right-radius:%?16?%;background-color:#fff;font-size:%?30?%;color:#999}.nav .acea-row[data-v-1199d7db]{border-top:%?5?% solid transparent;border-bottom:%?5?% solid transparent}.nav .acea-row.on[data-v-1199d7db]{border-bottom-color:var(--view-theme);color:#282828}.nav .acea-row[data-v-1199d7db]:only-child{border-bottom-color:transparent}.occupy[data-v-1199d7db]{height:%?106?%}.coupon-list .item[data-v-1199d7db]{margin-bottom:%?18?%;box-shadow:0 %?2?% %?10?% rgba(0,0,0,.06)}.coupon-list .item .money[data-v-1199d7db]{font-weight:400}',
          "",
        ]),
        (t.exports = e);
    },
    ...
    dd63: function (t, e, i) {
      ...
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* crmeb颜色变量 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.previewImg[data-v-4ac411c0]{position:fixed;top:0;left:0;z-index:300;width:100%;height:100%}.previewImg .mask[data-v-4ac411c0]{display:flex;justify-content:center;align-items:center;background-color:#000;opacity:1;z-index:8;width:100%;height:100%}.previewImg .mask-swiper[data-v-4ac411c0]{width:100%;height:100%}.previewImg .mask-swiper-img[data-v-4ac411c0]{width:100%}.previewImg .pagebox[data-v-4ac411c0]{position:absolute;width:100%;bottom:%?20?%;z-index:300;color:#fff;text-align:center}.mask_sku[data-v-4ac411c0]{color:#fff;max-width:80%;z-index:300;text-align:center;display:flex;flex-direction:column;align-items:center;margin-top:%?30?%}.mask_sku .sku_name[data-v-4ac411c0]{font-size:12px;border:1px solid #fff;padding:%?10?% %?30?% %?10?%;border-radius:40px;box-sizing:border-box}.mask_sku .sku_price[data-v-4ac411c0]{padding-top:10px}.font12[data-v-4ac411c0]{font-size:%?24?%}.share_btn[data-v-4ac411c0]{position:absolute;top:%?70?%;right:%?50?%;font-size:%?40?%;color:#fff;z-index:300}.flex-column[data-v-4ac411c0]{flex-direction:column}.justify-center[data-v-4ac411c0]{justify-content:center}.align-center[data-v-4ac411c0]{align-items:center}',
          "",
        ]),
        (t.exports = e);
    },
      ...
      var n = function () {
          ...
          return n(
            ...
            [
              n(
                "v-uni-view",
                { staticClass: "coupon-list-window", class: 1 == t.coupon.coupon ? "on" : "" },
                [
                  t.coupon.count
                    ? n(
                        "v-uni-view",
                        { staticClass: "nav acea-row row-around" },
                        [
                          t.coupon.count[2]
                            ? n(
                                "v-uni-view",
                                {
                                  class: ["acea-row", "row-middle", 2 === t.coupon.type ? "on" : ""],
                                  on: {
                                    click: function (e) {
                                      (arguments[0] = e = t.$handleEvent(e)), t.setType(2);
                                    },
                                  },
                                },
                                [t._v(t._s(t.$t("商品券")))]
                          ...
                          t.coupon.count[1]
                            ? n(
                                "v-uni-view",
                                {
                                  class: ["acea-row", "row-middle", 1 === t.coupon.type ? "on" : ""],
                                  on: {
                                    click: function (e) {
                                      (arguments[0] = e = t.$handleEvent(e)), t.setType(1);
                                    },
                                  },
                                },
                                [t._v(t._s(t.$t("品类券")))]
                          ...
                          t.coupon.count[0]
                            ? n(
                                "v-uni-view",
                                {
                                  class: ["acea-row", "row-middle", 0 === t.coupon.type ? "on" : ""],
                                  on: {
                                    click: function (e) {
                                      (arguments[0] = e = t.$handleEvent(e)), t.setType(0);
                                    },
                                  },
                                },
                                [t._v(t._s(t.$t("通用券")))]
                  ...
                  t.coupon.count ? n("v-uni-view", { staticClass: "occupy" }) : t._e(),
                  t.coupon.list.length
                    ? n(
                        "v-uni-view",
                        { staticClass: "coupon-list" },
                        t._l(t.coupon.list, function (e, a) {
                          return n(
                            "v-uni-view",
                            {
                              key: a,
                              staticClass: "item acea-row row-center-wrapper",
                              class: { svip: 4 === e.receive_type },
                              on: {
                                click: function (i) {
                                  (arguments[0] = i = t.$handleEvent(i)), t.getCouponUser(a, e.id);
                                },
                              },
                            },
                            [
                              n(
                                "v-uni-view",
                                { staticClass: "moneyCon acea-row row-center-wrapper" },
                                [
                                  n(
                                    "v-uni-view",
                                    {
                                      staticClass: "money acea-row row-column row-center-wrapper",
                                      class: e.is_use >= e.receive_limit && t.coupon.count ? "moneyGray" : "",
                                    },
                                    [
                                      n(
                                        "v-uni-view",
                                        [
                                          t._v(t._s(t.$t("￥"))),
                                          n("v-uni-text", { staticClass: "num" }, [t._v(t._s(e.coupon_price))]),
                                        ],
                                        1
                                      ),
                                      e.use_min_price > 0
                                        ? n("v-uni-view", { staticClass: "pic-num" }, [
                                            t._v(t._s(t.$t("满")) + t._s(e.use_min_price) + t._s(t.$t("元可用"))),
                                          ])
                                        : n("v-uni-view", { staticClass: "pic-num" }, [t._v(t._s(t.$t("无门槛券")))]),
                                    ],
                                    1
                                  ),
                                ],
                              ...
                              n(
                                ...
                                [
                                  n(
                                    "v-uni-view",
                                    { staticClass: "condition line2", class: t.coupon.count ? "" : "order" },
                                    [
                                      0 === e.type
                                        ? n(
                                            "span",
                                            {
                                              ...
                                              class: e.is_use >= e.receive_limit && t.coupon.count ? "gray" : "",
                                            },
                                            [t._v(t._s(t.$t("通用券")))]
                                          )
                                        : 1 === e.type
                                      ...
                                      4 === e.receive_type
                                        ? n("v-uni-image", { staticClass: "pic", attrs: { src: i("7206") } })
                                        : t._e(),
                                      n("span", { staticClass: "name" }, [t._v(t._s(t.$t(e.title)))]),
                                    ],
                                    1
                                  ),
                                  n(
                                    "v-uni-view",
                                    { staticClass: "data acea-row row-between-wrapper" },
                                    [
                                      e.coupon_time
                                        ? n("v-uni-view", [
                                        ...
                                        : n("v-uni-view", [
                                            t._v(
                                              t._s(e.start_use_time ? e.start_use_time + "-" : "") +
                                                t._s(e.end_use_time)
                                            ),
                                          ]),
                                      t.coupon.count
                                        ? n(
                                            "v-uni-view",
                                            [
                                              e.is_use >= e.receive_limit
                                                ? n("v-uni-view", { staticClass: "bnt gray" }, [
                                                    t._v(t._s(e.use_title || t.$t("已领取"))),
                                                  ])
                                                : n("v-uni-view", { staticClass: "bnt bg-color" }, [
                                                    t._v(t._s(t.coupon.statusTile || t.$t("立即领取"))),
                                                  ]),
                                            ],
                                            1
                                          )
                                        : n(
                                            "v-uni-view",
                                            { staticClass: "orderCou" },
                                            [
                                              e.is_use
                                                ? n("v-uni-view", {
                                                    staticClass: "iconfont icon-xuanzhong11",
                                                    class: 4 === e.receive_type ? "svip" : "font-num",
                                                  })
                                                : n("v-uni-view", { staticClass: "iconfont icon-weixuan" }),
                                            ],
                                            1
                                          ),
                                    ],
                    ...
                    : n(
                        "v-uni-view",
                        { staticClass: "pictrue" },
                        [n("v-uni-image", { attrs: { src: t.imgHost + "/statics/images/noCoupon.png" } })],
                        1
                      ),
                ],
                1
              ...
              n("v-uni-view", {
                staticClass: "mask",
                attrs: { catchtouchmove: "true", hidden: 0 == t.coupon.coupon },
                on: {
                  click: function (e) {
                    (arguments[0] = e = t.$handleEvent(e)), t.close.apply(void 0, arguments);
                  },
    ...
    ec16: function (t, e, i) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("1008733e", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    ed8e: function (t, e, i) {
      var n = i("78cb");
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("d72f8460", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    edcb: function (t, e, i) {
      "use strict";
      i.d(e, "b", function () {
      ...
      var n = function () {
          var t = this,
            e = t.$createElement,
            i = t._self._c || e;
          return t.sharePacket.isState
            ? i(
                "v-uni-view",
                { staticClass: "sharing-packets", class: t.sharePacket.isState && t.showAnimate ? "" : "right" },
                [
                  i(
                    "v-uni-view",
                    {
                      staticClass: "sharing-con",
                      on: {
                        click: function (e) {
                          (arguments[0] = e = t.$handleEvent(e)), t.goShare.apply(void 0, arguments);
                        },
                      },
                    },
                    [
                      i("v-uni-image", { attrs: { src: t.imgHost + "/statics/images/red-packets.png" } }),
                      i(
                        "v-uni-view",
                        { staticClass: "text font-color" },
                        [
                          i("v-uni-view", [t._v(t._s(t.$t("最高返佣")))]),
                          i(
                            "v-uni-view",
                            { staticClass: "money" },
                            [
                              i("v-uni-text", { staticClass: "label" }, [t._v(t._s(t.$t("￥")))]),
                              t._v(t._s(t.sharePacket.priceName)),
                            ],
                            1
                          ),
                          i("v-uni-view", { staticClass: "tip" }, [t._v(t._s(t.$t("推广享佣金")))]),
                          i("v-uni-view", { staticClass: "shareBut" }, [t._v(t._s(t.$t("立即分享")))]),
                        ],
                        1
                      ),
                    ],
    ...
    f7fa: function (t, e, i) {
      ...
      i("8acd");
      var s = i("f0c5"),
        r = Object(s["a"])(a["default"], n["b"], n["c"], !1, null, "1631a9a1", null, !1, n["a"], void 0);
      e["default"] = r.exports;
    },
    fd5e: function (t, e, i) {
      "use strict";
      ...
      i("daf7");
      var s = i("f0c5"),
        r = Object(s["a"])(a["default"], n["b"], n["c"], !1, null, "4ac411c0", null, !1, n["a"], void 0);
      e["default"] = r.exports;
    },
    feba: function (t, e, i) {
      "use strict";
        ...
        a = {
          props: {
            sharePacket: {
              type: Object,
              default: function () {
                return { isState: !0, priceName: "" };
              },
            },
            showAnimate: { type: Boolean, default: !0 },
          },
          watch: {
            showAnimate: function (t, e) {
              var i = this;
          ...
          data: function () {
            return { imgHost: n.HTTP_REQUEST_URL, isAnimate: !0 };
          },
          methods: {
            closeShare: function () {
            ...
            goShare: function () {
              this.isAnimate ? this.$emit("listenerActionSheet") : ((this.isAnimate = !0), this.$emit("boxStatus", !0));
            },
          },
        };
      e.default = a;
