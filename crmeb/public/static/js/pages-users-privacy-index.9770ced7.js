(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["pages-users-privacy-index"],
  {
    12320: function (t, e, i) {
      ...
      i("957c");
      var o = i("f0c5"),
        s = Object(o["a"])(n["default"], r["b"], r["c"], !1, null, "0b182b04", null, !1, r["a"], void 0);
      e["default"] = s.exports;
    },
    2183: function (t, e, i) {
      "use strict";
      ...
      var r = { jyfParser: i("47fd").default },
        n = function () {
          ...
          return e(
            "v-uni-view",
            { staticClass: "content" },
            [e("jyf-parser", { ref: "article", attrs: { html: this.content, "tag-style": this.tagStyle } })],
            1
          );
        },
        a = [];
    ...
    "47fd": function (t, e, i) {
      ...
      i("be15");
      var o = i("f0c5"),
        s = Object(o["a"])(n["default"], r["b"], r["c"], !1, null, "ad63bb64", null, !1, r["a"], void 0);
      e["default"] = s.exports;
    },
    "54f8": function (t, e, i) {
      "use strict";
      i("7a82"),
        ...
        (e.default = function (t, e) {
          ...
          if (!i) {
            if (Array.isArray(t) || (i = (0, r.default)(t)) || (e && t && "number" === typeof t.length)) {
              i && (t = i);
              var n = 0,
                a = function () {};
              return {
    ...
    "689c": function (t, e, i) {
      ...
      var n = r(i("47fd")),
        ...
        o = {
          ...
          onLoad: function (t) {
            var e = this;
            (0, a.getUserAgreement)(t.type)
              .then(function (t) {
                (e.content = t.data.content), uni.setNavigationBarTitle({ title: t.data.title });
              })
              .catch(function (t) {
                that.$util.Tips({ title: t });
              });
          },
        };
      e.default = o;
    ...
    7429: function (t, e, i) {
      ...
      n("5d16f60e", r, !0, { sourceMap: !1, shadowMode: !1 });
    },
    8713: function (t, e, i) {
      "use strict";
      i.d(e, "b", function () {
    ...
    9740: function (t, e, i) {
      ...
      (e = r(!1)),
        e.push([
          t.i,
          "uni-page-body[data-v-0b182b04]{background-color:#fff}body.?%PAGE?%[data-v-0b182b04]{background-color:#fff}.content[data-v-0b182b04]{padding:%?40?% %?30?%;line-height:2}",
          "",
        ]),
        (t.exports = e);
    },
    "9b07": function (t, e) {
      function i(t) {
        for (var e = {}, i = t.split(","), r = i.length; r--; ) e[i[r]] = !0;
        return e;
      }
      t.exports = {
        filter: null,
        ...
        _default = {
              ...
              (this.imgList.setItem = function (t, e) {
                if (void 0 != t && e) {
                  if (0 == e.indexOf("http") && this.includes(e)) {
                    for (var i, r = "", n = 0; (i = e[n]); n++) {
                      if ("/" == i && "/" != e[n - 1] && "/" != e[n + 1]) break;
                      r += Math.random() > 0.5 ? i.toUpperCase() : i;
                    }
                    return (r += e.substr(n)), (this[t] = r);
                  }
          ...
          methods: {
            _Dom2Str: function (t) {
              var e,
                i = "",
                r = (0, _createForOfIteratorHelper2.default)(t);
              try {
                for (r.s(); !(e = r.n()).done; ) {
                  var n = e.value;
                  if ("text" == n.type) i += n.text;
                  else {
                    for (var a in ((i += "<" + n.name), n.attrs || {})) i += " " + a + '="' + n.attrs[a] + '"';
            ...
            _handleHtml: function (t, e) {
              if (
                ...
                for (var r in cfg.userAgentStyles) i += "".concat(r, "{").concat(cfg.userAgentStyles[r], "}");
                for (r in this.tagStyle) i += "".concat(r, "{").concat(this.tagStyle[r], "}");
                (i += "</style>"), (t = i + t);
              }
              return t;
            },
              ...
              if (t) {
                ...
                e
                  ? this.rtf
                    ...
                    : (this.rtf = r)
                  : (this.rtf && this.rtf.parentNode.removeChild(this.rtf), (this.rtf = r)),
                  (r.innerHTML = this._handleHtml(t, e));
                for (var n, a = this.rtf.getElementsByTagName("style"), o = 0; (n = a[o++]); )
                ...
                var p,
                  m = this.rtf.getElementsByTagName("a"),
                  _ = (0, _createForOfIteratorHelper2.default)(m);
                try {
                  for (_.s(); !(p = _.n()).done; ) {
                    var g = p.value;
                    g.onclick = function () {
                ...
                var v = this.rtf.getElementsByTagName("video");
                s.videoContexts = v;
                for (var b, y = 0; (b = v[y++]); )
                ...
                var x,
                  ...
                  T = (0, _createForOfIteratorHelper2.default)(k);
                try {
                  for (T.s(); !(x = T.n()).done; ) {
                    var A = x.value;
                    A.onerror = function () {
                ...
                (this.document = this.rtf),
                  ...
                  (this._timer = setInterval(function () {
                    ...
                    (i.width = t[0].width),
                      t[0].height == w && (i.$emit("ready", t[0]), clearInterval(i._timer)),
                      (w = t[0].height);
                  }, 350)),
    ...
    ed29: function (t, e, i) {
      ...
      r.__esModule && (r = r.default),
        ...
        r.locals && (t.exports = r.locals);
      var n = i("4f06").default;
      n("7e9964aa", r, !0, { sourceMap: !1, shadowMode: !1 });
    },
  },
]);
