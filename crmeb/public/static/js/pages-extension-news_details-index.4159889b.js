(window["webpackJsonp"] = window["webpackJsonp"] || []).push([
  ["pages-extension-news_details-index"],
  {
    "01f0": function (t, e, i) {
      "use strict";
      var n = i("a23e"),
    ...
    "0312": function (t, e, i) {
      ...
      var n = { jyfParser: i("47fd").default },
        a = function () {
          var t = this,
            e = t.$createElement,
            i = t._self._c || e;
          return i(
            ...
            [
              i(
                ...
                [
                  i("v-uni-view", { staticClass: "title" }, [t._v(t._s(t.articleInfo.title || ""))]),
                  i(
                    "v-uni-view",
                    { staticClass: "list acea-row row-middle" },
                    [
                      i("v-uni-view", { staticClass: "label" }, [t._v(t._s(t.articleInfo.catename || ""))]),
                      i("v-uni-view", { staticClass: "item" }, [t._v(t._s(t.articleInfo.add_time || ""))]),
                      i(
                        "v-uni-view",
                        { staticClass: "item" },
                        [
                          i("v-uni-text", { staticClass: "iconfont icon-liulan" }),
                          t._v(t._s(t.articleInfo.visit || "")),
                        ],
                        1
                      ),
                    ],
                  ...
                  i(
                    "v-uni-view",
                    { staticClass: "conters" },
                    [i("jyf-parser", { ref: "article", attrs: { html: t.content, "tag-style": t.tagStyle } })],
                    1
                  ),
                  t.store_info.id
                    ? i(
                        "v-uni-navigator",
                        {
                          ...
                          attrs: { url: "/pages/goods_details/index?id=" + t.store_info.id, "hover-class": "none" },
                        },
                        [
                          i(
                            "v-uni-view",
                            { staticClass: "pictrue" },
                            [i("v-uni-image", { attrs: { src: t.store_info.image } })],
                            1
                          ),
                          i(
                            "v-uni-view",
                            { staticClass: "text" },
                            [
                              i("v-uni-view", { staticClass: "name line1" }, [
                                t._v(t._s(t.store_info.store_name || "")),
                              ]),
                              i(
                                "v-uni-view",
                                ...
                                [
                                  t._v(t._s(t.$t("￥"))),
                                  i("v-uni-text", { staticClass: "num" }, [t._v(t._s(t.store_info.price || 0))]),
                                ],
                                1
                              ),
                              i("v-uni-view", { staticClass: "y_money" }, [
                                t._v(t._s(t.$t("￥")) + t._s(t.store_info.ot_price || 0)),
                              ]),
                            ],
                            1
                          ),
                          i(
                            "v-uni-navigator",
                            { staticClass: "label" },
                            [i("v-uni-text", { staticClass: "span" }, [t._v(t._s(t.$t("查看商品")))])],
                            1
                          ),
                        ],
                        1
              ...
              i("shareInfo", {
                attrs: { shareInfoStatus: t.shareInfoStatus },
                on: {
                  setShareInfoStatus: function (e) {
                    (arguments[0] = e = t.$handleEvent(e)), t.setShareInfoStatus.apply(void 0, arguments);
                  },
                },
              }),
              i("home"),
    ...
    "11e5": function (t, e, i) {
      ...
      var n = function () {
          var t = this,
            e = t.$createElement,
            i = t._self._c || e;
          return t.shareInfoStatus
            ? i(
                "v-uni-view",
                { staticClass: "poster-first" },
                [
                  i(
                    "v-uni-view",
                    { staticClass: "mask-share" },
                    [
                      i("v-uni-image", {
                        attrs: { src: t.imgHost + "/statics/images/share-info.png" },
                        on: {
                          click: function (e) {
                            (arguments[0] = e = t.$handleEvent(e)), t.shareInfoClose.apply(void 0, arguments);
                          },
                          touchmove: function (e) {
                            e.stopPropagation(),
                              e.preventDefault(),
                              (arguments[0] = e = t.$handleEvent(e)),
                              (!1).apply(void 0, arguments);
                          },
                        },
                      }),
                    ],
    ...
    "285f": function (t, e, i) {
      ...
      i("c841");
      var o = i("f0c5"),
        s = Object(o["a"])(a["default"], n["b"], n["c"], !1, null, "2a6e0e59", null, !1, n["a"], void 0);
      e["default"] = s.exports;
    },
    3918: function (t, e, i) {
      var n = i("24fb");
      (e = n(!1)),
        e.push([
          t.i,
          '@charset "UTF-8";\n/**\n * 这里是uni-app内置的常用样式变量\n *\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\n *\n */\n/**\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\n *\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\n */\n/* 颜色变量 */\n/* 行为相关颜色 */\n/* crmeb颜色变量 */\n/* 背景颜色 */\n/* 边框颜色 */\n/* 尺寸变量 */\n/* 文字尺寸 */\n/* 图片尺寸 */\n/* Border Radius */\n/* 水平间距 */\n/* 垂直间距 */\n/* 透明度 */\n/* 文章场景相关 */.poster-first[data-v-746a0474]{overscroll-behavior:contain}.mask-share[data-v-746a0474]{position:fixed;top:0;left:0;right:0;bottom:0;z-index:99}.mask-share uni-image[data-v-746a0474]{width:100%;height:100%}',
          "",
        ]),
        (t.exports = e);
    },
    "3b71": function (t, e, i) {
      ...
      i("77b4");
      var o = i("f0c5"),
        s = Object(o["a"])(a["default"], n["b"], n["c"], !1, null, "5c721f6d", null, !1, n["a"], void 0);
      e["default"] = s.exports;
    },
    "47fd": function (t, e, i) {
      "use strict";
    ...
    "4e1e": function (t, e, i) {
      ...
      i("01f0");
      var o = i("f0c5"),
        s = Object(o["a"])(a["default"], n["b"], n["c"], !1, null, "746a0474", null, !1, n["a"], void 0);
      e["default"] = s.exports;
    },
    "54f8": function (t, e, i) {
      "use strict";
    ...
    "66b3": function (t, e, i) {
      ...
      a("6b063c40", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    "6cbb": function (t, e, i) {
      "use strict";
      i("7a82");
      ...
      var a = i("26cb"),
        ...
        s = {
          ...
          computed: (0, a.mapGetters)(["homeActive"]),
          methods: {
    ...
    a23e: function (t, e, i) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("ed55478e", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
    aae6: function (t, e, i) {
      var n = i("24fb");
      (e = n(!1)),
    ...
    d507: function (t, e, i) {
      ...
      var a = i("5743"),
        ...
        l = i("d1ea"),
        u = {
          components: { shareInfo: r.default, home: o.default, "jyf-parser": s.default },
          mixins: [c.default],
          data: function () {
            return {
              id: 0,
          ...
          onLoad: function (t) {
            t.hasOwnProperty("id") ? (this.id = t.id) : history.back();
          },
          onShow: function () {
            this.getArticleOne();
          },
          onShareAppMessage: function () {
            return (
              ...
              (0, l.userShare)(),
              {
                ...
                path: "/pages/extension/news_details/index?id=" + this.id + "&spid=" + this.$store.state.app.uid,
              }
            );
          },
          onShareTimeline: function () {
            return (
              ...
              {
                title: this.articleInfo.title,
                query: { id: this.id, spid: this.$store.state.app.uid || 0 },
                imageUrl: this.articleInfo.image_input.length ? this.articleInfo.image_input[0] : "",
              }
            );
          },
          methods: {
            getArticleOne: function () {
              var t = this,
                e = this;
              (0, a.getArticleDetails)(e.id).then(function (i) {
                uni.setNavigationBarTitle({ title: i.data.title.substring(0, 7) + "..." }),
                  e.$set(e, "articleInfo", i.data),
                  e.$set(e, "store_info", i.data.store_info ? i.data.store_info : {}),
                  (e.content = i.data.content),
                  t.$wechat.isWeixin() && t.setShareInfo();
              });
            },
            listenerActionSheet: function () {
              this.shareInfoStatus = !0;
            },
            setShareInfoStatus: function () {
              this.shareInfoStatus = !1;
            },
            setShareInfo: function () {
              var t = location.href + "&spid=" + this.$store.state.app.uid,
                e = {
                  title: this.articleInfo.title,
    ...
    dd64: function (t, e, i) {
      ...
      var n = i("00a0"),
        a = {
          props: { shareInfoStatus: { type: Boolean, default: !1 } },
          data: function () {
            return { imgHost: n.HTTP_REQUEST_URL };
          },
          mounted: function () {},
          methods: {
          ...
          methods: {
            ...
            setContent: function (t, e) {
              ...
              if (t) {
                ...
                for (var l, u = this.rtf.getElementsByTagName("img"), d = 0, f = 0; (l = u[d]); d++) {
                  ...
                  this.domain &&
                    ...
                    ("/" == h[0]
                      ? "/" == h[1]
                        ? (l.src = (this.domain.includes("://") ? this.domain.split("://")[0] : "") + ":" + h)
                        : (l.src = this.domain + h)
                      : h.includes("://") || (l.src = this.domain + "/" + h)),
                ...
                var p,
                  ...
                  m = (0, _createForOfIteratorHelper2.default)(v);
                try {
                  for (m.s(); !(p = m.n()).done; ) {
                    var g = p.value;
                    g.onclick = function () {
                ...
                var _ = this.rtf.getElementsByTagName("video");
                s.videoContexts = _;
                for (var b, w = 0; (b = _[w++]); )
                ...
                var y,
                  x,
                  T = this.rtf.getElementsByTagName("audios"),
                  k = (0, _createForOfIteratorHelper2.default)(T);
                try {
                  for (k.s(); !(y = k.n()).done; ) {
                    var S = y.value;
                    S.onerror = function () {
                ...
                (this.document = this.rtf),
                  ...
                  (this._timer = setInterval(function () {
                    ...
                    (i.width = t[0].width),
                      t[0].height == x && (i.$emit("ready", t[0]), clearInterval(i._timer)),
                      (x = t[0].height);
                  }, 350)),
    ...
    efc4: function (t, e, i) {
      ...
      n.__esModule && (n = n.default),
        ...
        n.locals && (t.exports = n.locals);
      var a = i("4f06").default;
      a("24378372", n, !0, { sourceMap: !1, shadowMode: !1 });
    },
  },
]);
