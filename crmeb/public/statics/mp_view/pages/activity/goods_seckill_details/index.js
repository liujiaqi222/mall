(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/activity/goods_seckill_details/index"],
  {
    "0a6c": function (t, e, i) {
      ...
      i("30ab");
      var u = i("f0c5"),
        n = Object(u["a"])(o["default"], s["b"], s["c"], !1, null, null, null, !1, s["a"], void 0);
      e["default"] = n.exports;
    },
    "30ab": function (t, e, i) {
      "use strict";
        ...
        var r,
          ...
          b =
            ((r = {
              ...
              mixins: [d.default, p.sharePoster],
              components: {
                ...
                countDown: function () {
                  i.e("components/countDown/index")
                    .then(
                      function () {
                        return resolve(i("80f6"));
                      }.bind(null, i)
                    )
                    .catch(i.oe);
                },
            ...
            (0, u.default)(r, "computed", (0, n.mapGetters)(["isLogin"])),
            (0, u.default)(r, "watch", {
              isLogin: {
            ...
            (0, u.default)(r, "onLoad", function (e) {
              var i = this,
                s = this,
                o = getCurrentPages();
              e.id && ((this.id = e.id), e.pid && (m.globalData.spid = e.pid)),
                (s.returnShow = 1 !== o.length),
                t.getSystemInfoSync({
                  success: function (t) {
                    (s.height = t.windowHeight), t.statusBarHeight;
                  },
                }),
                (this.navH = m.globalData.navHeight);
              var r = t.getMenuButtonBoundingClientRect();
              if (((this.meunHeight = r.height), (this.backH = s.navH / 2 + this.meunHeight / 2), e.scene)) {
                var u = this.$util.getUrlParams(decodeURIComponent(e.scene));
                if (!u.id) return this.$util.Tips({ title: this.$t("缺少参数无法查看商品") }, { tab: 3, url: 1 });
                (this.id = u.id), u.pid && (m.globalData.spid = u.pid);
              }
              this.isLogin ? this.getSeckillDetail() : (0, h.toLogin)(),
                this.$nextTick(function () {
                  var e = t.getMenuButtonBoundingClientRect(),
                    s = t.createSelectorQuery().in(i);
                  s.select("#home")
                    .boundingClientRect(function (t) {
                      i.homeTop = 2 * e.top + e.height - t.height;
                    })
                    .exec();
                });
            }),
            (0, u.default)(r, "onNavigationBarButtonTap", function (t) {
              this.currentPage = !this.currentPage;
            }),
            (0, u.default)(r, "methods", {
              moreNav: function () {
                this.currentPage = !this.currentPage;
              },
              ...
              getSeckillDetail: function () {
                var e = this,
                  i = this;
                (0, a.getSeckillDetail)(i.id, {})
                  .then(function (s) {
                    (e.dataShow = 1), (e.status = s.data.storeInfo.status);
                    var o = s.data.storeInfo.title;
                    for (var r in ((e.storeInfo = s.data.storeInfo),
                    (e.datatime = Number(s.data.storeInfo.last_time)),
                    (e.imgUrls = s.data.storeInfo.images),
                    ...
                    i.$set(i.attribute, "productAttr", s.data.productAttr),
                    (e.productValue = s.data.productValue),
                    (e.attribute.productSelect.num = s.data.storeInfo.num),
                    (e.attribute.productSelect.once_num = s.data.storeInfo.once_num),
                    (e.replyCount = s.data.replyCount),
                    (e.reply = s.data.reply ? [s.data.reply] : []),
                    (e.replyChance = s.data.replyChance),
                    (i.routineContact = Number(s.data.routine_contact_type)),
                    t.setNavigationBarTitle({ title: o.substring(0, 7) + "..." }),
                    s.data.productValue)) {
                      var u = s.data.productValue[r];
                      i.skuArr.push(u);
                    }
                    e.$set(e, "selectSku", i.skuArr[0]);
                    var n = [i.$t("商品"), i.$t("详情")];
                    s.data.replyCount && n.splice(1, 0, i.$t("评价")),
                      i.$set(i, "navList", n),
                      e.storeInfo.wechat_code && i.$set(i, "PromotionCode", e.storeInfo.wechat_code),
              ...
              downloadFilePromotionCode: function (e) {
                var i = this;
                (0, a.seckillCode)(i.id)
                  .then(function (s) {
                    t.downloadFile({
                      url: i.setDomain(s.data.code),
                      success: function (t) {
                        i.$set(i, "isDown", !1),
                          i.$set(i, "PromotionCode", t.tempFilePath),
                          "function" == typeof e && e && e(t.tempFilePath);
                      },
                      fail: function () {
                        i.$set(i, "isDown", !1), i.$set(i, "PromotionCode", "");
                      },
                    });
                  })
                  .catch(function (t) {
              ...
              ChangeCartNum: function (t) {
                ...
                if (
                  ...
                  var i = e.quota || 0,
                    ...
                    r = this.storeInfo.num || 0,
                    u = this.storeInfo.once_num || 0;
                  if ((void 0 == e.cart_num && (e.cart_num = 1), t)) {
                    o.cart_num++;
                    var n = [];
                    n.push(r), n.push(u), n.push(i), n.push(s);
                    var a = Math.min.apply(null, n);
                    o.cart_num >= a &&
                      (this.$set(this.attribute.productSelect, "cart_num", a || 1),
                      this.$set(this, "cart_num", a || 1)),
              ...
              tap: function (t, e) {
                ...
                this.replyCount || "past1" != i || (i = "past2"),
                  ...
                  (this.navActive = e),
                  (this.lock = !0),
                  (this.scrollTop = e > 0 ? this.topArr[e] - m.globalData.navHeight / 2 : this.topArr[e]);
              },
              infoScroll: function () {
                for (var t = this, e = [], i = [], o = 0; o < t.navList.length; o++) {
                  var r = s.createSelectorQuery().in(this),
                    u = "#past" + o;
                  this.replyCount || 1 != o || (u = "#past2"),
                    r.select(u).boundingClientRect(),
                    r.exec(function (s) {
                      var o = s[0].top,
                        r = s[0].height;
                      e.push(o), i.push(r), (t.topArr = e), (t.heightArr = i);
                    });
                }
              },
              setCollect: function () {
              ...
              openAlone: function () {
                t.navigateTo({ url: "/pages/goods_details/index?id=".concat(this.storeInfo.product_id) });
              },
              goCat: function () {
                var e = this;
                this.currentPage = !1;
                ...
                return (
                  ...
                  !0 === this.attribute.cartAttr && 0 == this.isOpen
                    ? (this.isOpen = !0)
                    : this.attribute.productAttr.length && void 0 === i && 1 == this.isOpen
                    ? m.$util.Tips({ title: this.$t("请选择属性") })
              ...
              listenerActionSheet: function () {
                !1 === this.isLogin ? (0, h.toLogin)() : (this.posters = !0);
              },
              ...
              setShareInfoStatus: function () {
                ...
                this.$wechat.isWeixin() &&
                  ((this.posters = !0),
                  (0, l.getUserInfo)().then(function (s) {
                    i = -1 === i.indexOf("?") ? i + "?spread=" + s.data.uid : i + "&spread=" + s.data.uid;
            ...
            (0, u.default)(r, "onShareAppMessage", function () {
              return {
                title: this.storeInfo.title,
                path:
                  "/pages/activity/goods_seckill_details/index?id=" + this.id + "&spid=" + this.$store.state.app.uid,
      ...
      var s = function () {
          var t = this,
            ...
            s =
              ...
              (t.attribute.productAttr.length ? t.attribute.productAttr[0].attr_values.length : 0) > 1,
            o = s ? t.$t("起") : null,
            r = t.$t("￥"),
            u = 1 == t.status ? t.$t("距秒杀结束仅剩") : null,
            n = t.$t("累计销售"),
            a = t.$t(t.storeInfo.unit_name) || "",
            c = t.$t("限量剩余"),
            h = t.$t(t.storeInfo.unit_name) || "",
            l = t.attribute.productAttr.length,
            d = l ? t.skuArr.length : null,
            p = l && d > 1 ? t.skuArr.slice(0, 4) : null,
            f = l && d > 1 ? t.$t("共") : null,
            m = l && d > 1 ? t.skuArr.length : null,
            g = l && d > 1 ? t.$t("种规格可选") : null,
            b = t.replyCount ? t.$t("用户评价") : null,
            $ = t.replyCount ? t.$t("好评率") : null,
            S = t.$t("产品介绍"),
            v = t.$t("首页"),
            _ = t.$t("收藏"),
            I =
              ...
              t.storeInfo.product_is_show
                ...
                : null,
            w =
              1 == t.status && t.attribute.productSelect.quota > 0 && t.attribute.productSelect.product_stock > 0
                ? t.$t("立即购买")
                : null,
            A =
            ...
            k =
              ...
              (3 == t.status && t.attribute.productSelect.product_stock <= 0)
                ? t.$t("已售罄")
                : null,
            x = !t.dataShow && 1 == t.status && t.storeInfo.product_is_show ? t.$t("单独购买") : null,
            C = t.dataShow || 1 != t.status ? null : t.$t("立即购买"),
            P = 2 == t.status && t.storeInfo.product_is_show ? t.$t("单独购买") : null,
            y = 2 == t.status ? t.$t("未开始") : null,
            q = 0 == t.status && t.storeInfo.product_is_show ? t.$t("单独购买") : null,
            T = 0 == t.status ? t.$t("已结束") : null,
            D = t.$t("发送给朋友"),
            V = t.$t("生成海报"),
            H = t.posterImageStatus ? t.$t("保存到手机") : null;
          t._isMounted ||
            (t.e0 = function (e) {
              t.H5ShareBox = !1;
            }),
  ...
  [["eec2", "common/runtime", "common/vendor"]],
]);
