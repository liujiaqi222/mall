(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/activity/goods_combination_details/index"],
  {
    ...
    "3ed8": function (t, e, i) {
      ...
      var s = function () {
          var t = this,
            ...
            u = t.$t("人团"),
            a = t.$t("累计销量"),
            c = t.$t(t.storeInfo.unit_name) || "",
            h = t.$t("限量剩余"),
            l = t.$t(t.storeInfo.unit_name) || "",
            d = t.attribute.productAttr.length,
            p = d ? t.skuArr.length : null,
            f = d && p > 1 ? t.skuArr.slice(0, 4) : null,
            m = d && p > 1 ? t.$t("共") : null,
            g = d && p > 1 ? t.skuArr.length : null,
            $ = d && p > 1 ? t.$t("种规格可选") : null,
            b = t.$t("已拼"),
            v = t.$t("件"),
            S = t.__map(t.pink, function (e, i) {
              var s = t.__get_orig(e),
                o = i < t.AllIndex ? t.$t("还差") : null,
                n = i < t.AllIndex ? t.$t("人成团") : null,
                r = i < t.AllIndex ? t.$t("去拼单") : null;
              return { $orig: s, m13: o, m14: n, m15: r };
            }),
            _ = t.pink.length,
            I = _ ? t.pink.length : null,
            A = _ && I > t.AllIndex ? t.$t("查看更多") : null,
            w = !_ || I > t.AllIndex ? null : t.pink.length === t.AllIndex && t.pink.length !== t.AllIndexDefault,
            k = !_ || I > t.AllIndex || !w ? null : t.$t("收起"),
            x = t.$t("拼团玩法"),
            C = t.$t("开团/参团"),
            P = t.$t("邀请好友"),
            y = t.$t("满员发货"),
            T = t.replyCount ? t.$t("用户评价") : null,
            q = t.replyCount ? t.$t("好评率") : null,
            D = t.$t("产品介绍"),
            V = t.$t("首页"),
            L = t.$t("收藏"),
            O = t.storeInfo.product_is_show ? t.$t("单独购买") : null,
            H =
              t.attribute.productSelect.product_stock > 0 && t.attribute.productSelect.quota > 0
                ? t.$t("立即开团")
                : null,
            N = t.dataShow ? null : t.$t("立即开团"),
            M =
            ...
            U = t.$t("发送给朋友"),
            F = t.$t("生成海报"),
            B = t.posterImageStatus ? t.$t("保存到手机") : null;
          t._isMounted ||
            (t.e0 = function (e) {
              t.H5ShareBox = !1;
            }),
    ...
    a5ca: function (t, e, i) {
      ...
      (function (t) {
        ...
        var o = i("26cb"),
          ...
          l = i("00a0"),
          d = getApp(),
          p = t.getSystemInfoSync().statusBarHeight + "px",
          f = {
            components: {
            ...
            mixins: [c.default, h.sharePoster],
            data: function () {
              return {
                imgHost: l.HTTP_REQUEST_URL,
                dataShow: 0,
                navH: "",
                id: 0,
                userInfo: {},
            ...
            onLoad: function (e) {
              ...
              if (
                ...
                (this.navH = d.globalData.navHeight),
                t.getSystemInfoSync({
                  success: function (t) {
                    s.height = t.windowHeight;
                  },
                }),
                e.scene)
              ) {
                var r = this.$util.getUrlParams(decodeURIComponent(e.scene));
                r.id && (e.id = r.id), r.pid && (d.globalData.spid = r.pid);
              }
              if (!e.id && !e.scene)
                return this.$util.Tips({ title: this.$t("缺少参数无法查看商品") }, { tab: 3, url: 1 });
              if ((e.spid && (d.globalData.spid = e.spid), e.hasOwnProperty("id")))
                (this.id = e.id),
                  this.isLogin
                    ? this.combinationDetail()
                    : (this.$Cache.set(
                        "login_back_url",
                        "/pages/activity/goods_combination_details/index?id=".concat(e.id)
                      ),
                      (0, n.toLogin)());
              else
                try {
                  var u = t.getStorageSync("comGoodsId");
                  "" != u && ((this.id = u), this.combinationDetail());
                } catch (a) {
                  t.showToast({ title: this.$t("参数错误"), icon: "none", duration: 1e3, mask: !0 });
                }
            },
            ...
            methods: {
              ...
              combinationDetail: function () {
                var e = this,
                  i = this,
                  s = i.id;
                (0, r.getCombinationDetail)(s)
                  .then(function (s) {
                    for (var o in ((i.dataShow = 1),
                    t.setNavigationBarTitle({ title: s.data.storeInfo.title.substring(0, 16) }),
                    (i.imgUrls = s.data.storeInfo.images),
                    (i.storeInfo = s.data.storeInfo),
                    (i.storeInfo.description = i.storeInfo.description.replace(
                      /<img/gi,
                      '<img style="max-width:100%;height:auto;float:left;display:block" '
                    )),
                    (i.attribute.productSelect.num = s.data.storeInfo.num),
                    (i.pink = s.data.pink),
                    (i.pinkAll = s.data.pinkAll),
                    (i.reply = s.data.reply ? [s.data.reply] : []),
                    (i.replyCount = s.data.replyCount),
                    (i.itemNew = s.data.pink_ok_list),
                    (i.pink_ok_sum = s.data.pink_ok_sum),
                    (i.replyChance = s.data.replyChance),
                    (i.attribute.productAttr = s.data.productAttr),
                    (i.productValue = s.data.productValue),
                    e.storeInfo.wechat_code && i.$set(i, "PromotionCode", e.storeInfo.wechat_code),
                    (i.routineContact = Number(s.data.routine_contact_type)),
                    s.data.productValue)) {
                      var n = s.data.productValue[o];
                      i.skuArr.push(n);
                    }
                    i.$set(i, "selectSku", i.skuArr[0]);
                    var r = [i.$t("商品"), i.$t("详情")];
                    s.data.replyCount && r.splice(1, 0, i.$t("评价")),
                      i.$set(i, "navList", r),
                      (i.storeImage = i.storeInfo.image),
                  ...
                  .catch(function (t) {
                    i.$util.Tips({ title: t }, { tab: 3 });
                  });
              },
              downloadFileAppCode: function () {
                var e = this;
                t.downloadFile({
                  url: e.setDomain(e.PromotionCode),
                  success: function (t) {
                    e.PromotionCode = t.tempFilePath;
                  },
                  fail: function () {
                    return e.$util.Tips({ title: "" });
                  },
                });
              },
              ...
              infoScroll: function () {
                for (var e = this, i = [], s = [], o = 0; o < e.navList.length; o++) {
                  var n = t.createSelectorQuery().in(this),
                    r = "#past" + o;
                  this.replyCount || 1 != o || (r = "#past2"),
                    n.select(r).boundingClientRect(),
                    n.exec(function (t) {
                      var o = t[0].top,
                        n = t[0].height;
                      i.push(o), s.push(n), (e.topArr = i), (e.heightArr = s);
                    });
                }
              },
              ...
              ChangeCartNum: function (t) {
                ...
                if (
                  ...
                  var i = e.quota || 0,
                    ...
                    n = this.storeInfo.num || 0;
                  if ((void 0 == e.cart_num && (e.cart_num = 1), t)) {
                    o.cart_num++;
                    var r = [];
                    r.push(n), r.push(i), r.push(s);
                    var u = Math.min.apply(null, r);
                    o.cart_num >= u &&
                      (this.$set(this.attribute.productSelect, "cart_num", u || 1),
                      this.$set(this, "cart_num", u || 1)),
              ...
              goProduct: function () {
                t.navigateTo({ url: "/pages/goods_details/index?id=" + this.storeInfo.product_id });
              },
              goCat: function () {
                var e = this;
                this.currentPage = !1;
                ...
                if (this.attribute.productAttr.length && void 0 === i && 1 == this.isOpen)
                  return e.$util.Tips({ title: this.$t("请选择") });
                var s = {
                  productId: e.storeInfo.product_id,
                  secKillId: 0,
                  bargainId: 0,
                  combinationId: e.id,
                  cartNum: e.cart_num,
              ...
              listenerActionSheet: function () {
                (this.currentPage = !1), 0 == this.isLogin ? (0, n.toLogin)() : (this.posters = !0);
              },
              ...
              downloadFilePromotionCode: function (e) {
                var i = this;
                (0, r.scombinationCode)(i.id)
                  .then(function (s) {
                    t.downloadFile({
                      url: i.setDomain(s.data.code),
                      success: function (t) {
                        i.$set(i, "isDown", !1),
                          "function" == typeof e ? e && e(t.tempFilePath) : i.$set(i, "PromotionCode", t.tempFilePath);
                      },
                      fail: function () {
                  ...
                  success: function (i) {
                    i.authSetting["scope.writePhotosAlbum"]
                      ? t.saveImageToPhotosAlbum({
                          ...
                          success: function (t) {
                            e.posterImageClose(), e.$util.Tips({ title: this.$t("保存成功"), icon: "success" });
                          },
                          fail: function (t) {
                            e.$util.Tips({ title: this.$t("保存失败") });
                          },
                        })
                      : t.authorize({
              ...
              setShareInfoStatus: function () {
                ...
                this.$wechat.isWeixin() &&
                  (0, a.getUserInfo)().then(function (s) {
              ...
              scroll: function (t) {
                ...
                if (
                  ...
                  for (var s = 0; s < this.topArr.length; s++)
                    if (e < this.topArr[s] - d.globalData.navHeight / 2 + this.heightArr[s]) {
                      this.navActive = s;
                      break;
                    }
              },
              tap: function (t, e) {
                ...
                this.replyCount || "past1" != i || (i = "past2"),
                  ...
                  (this.navActive = e),
                  (this.lock = !0),
                  (this.scrollTop = e > 0 ? this.topArr[e] - d.globalData.navHeight / 2 : this.topArr[e]);
              },
              showImg: function (t) {
    ...
    c445: function (t, e, i) {
      ...
      i("e2a1");
      var r = i("f0c5"),
        u = Object(r["a"])(o["default"], s["b"], s["c"], !1, null, null, null, !1, s["a"], void 0);
      e["default"] = u.exports;
    },
    e2a1: function (t, e, i) {
      "use strict";
  ...
  [["87af", "common/runtime", "common/vendor"]],
]);
