...
(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/points_mall/integral_goods_details"],
  {
    ...
    7562: function (t, e, i) {
      ...
      i("8179");
      var o = i("f0c5"),
        n = Object(o["a"])(s["default"], r["b"], r["c"], !1, null, null, null, !1, r["a"], void 0);
      e["default"] = n.exports;
    },
    "7db1": function (t, e, i) {
      "use strict";
      ...
      var r = {
          jyfParser: function () {
            return Promise.all([i.e("common/vendor"), i.e("components/jyf-parser/jyf-parser")]).then(
              i.bind(null, "47fd")
            );
          },
        },
        s = function () {
          var t = this,
            e = t.$createElement,
            i = (t._self._c, t.$t("积分")),
            r = t.storeInfo.num > 0 ? t.$t("最多可兑换") : null,
            s = t.storeInfo.num > 0 ? t.$t(t.storeInfo.unit_name) : null,
            u = t.$t("划线价"),
            o = t.$t("限量"),
            n = t.$t("已兑换"),
            a = t.attribute.productAttr.length,
            c = a ? t.skuArr.length : null,
            h = a && c > 1 ? t.skuArr.slice(0, 4) : null,
            l = a && c > 1 ? t.$t("共") : null,
            d = a && c > 1 ? t.skuArr.length : null,
            p = a && c > 1 ? t.$t("种规格可选") : null,
            f = t.$t("产品介绍"),
            m = t.$t("首页"),
            b =
    ...
    b6d8: function (t, e, i) {
      ...
      (function (t) {
        ...
        var s,
          ...
          c = (i("d1ea"), r(i("19b6"))),
          h = getApp(),
          l = t.getSystemInfoSync().statusBarHeight + "px",
          d =
            ((s = {
              computed: (0, o.mapGetters)(["isLogin"]),
              mixins: [c.default],
              data: function () {
                return {
                  dataShow: 0,
              ...
              components: {
                ...
                productWindow: function () {
                  i.e("pages/points_mall/component/productWindow")
                    .then(
                      function () {
                        return resolve(i("dabf"));
                      }.bind(null, i)
                    )
                    .catch(i.oe);
                },
            ...
            (0, u.default)(s, "computed", (0, o.mapGetters)(["isLogin"])),
            (0, u.default)(s, "watch", {
              isLogin: {
            ...
            (0, u.default)(s, "onLoad", function (e) {
              var i = this,
                r = this,
                s = getCurrentPages();
              (r.returnShow = 1 !== s.length),
                t.getSystemInfoSync({
                  success: function (t) {
                    (r.height = t.windowHeight), t.statusBarHeight;
                  },
                }),
                (this.navH = h.globalData.navHeight);
              var u = t.getMenuButtonBoundingClientRect();
              if (((this.meunHeight = u.height), (this.backH = r.navH / 2 + this.meunHeight / 2), e.scene)) {
                var o = this.$util.getUrlParams(decodeURIComponent(e.scene));
                if (!o.id) return this.$util.Tips({ title: this.$t("缺少参数无法查看商品") }, { tab: 3, url: 1 });
                (this.id = o.id), o.pid && (h.globalData.spid = o.pid), o.time && (this.datatime = o.time);
              }
              e.id && ((this.id = e.id), (this.datatime = Number(e.time)), (this.status = e.status)),
                this.isLogin ? this.getIntegralProductDetail() : (0, a.toLogin)(),
                this.$nextTick(function () {
                  var e = t.getMenuButtonBoundingClientRect(),
                    r = t.createSelectorQuery().in(i);
                  r.select("#home")
            ...
            (0, u.default)(s, "onNavigationBarButtonTap", function (t) {
              this.currentPage = !this.currentPage;
            }),
            (0, u.default)(s, "methods", {
              moreNav: function () {
                this.currentPage = !this.currentPage;
              },
              ...
              getIntegralProductDetail: function () {
                var e = this,
                  i = this;
                (0, n.getIntegralProductDetail)(i.id)
                  .then(function (r) {
                    e.dataShow = 1;
                    var s = r.data.storeInfo.title;
                    for (var u in ((e.storeInfo = r.data.storeInfo),
                    (e.imgUrls = r.data.storeInfo.images),
                    (e.storeInfo.description = e.storeInfo.description.replace(
                      /<img/gi,
                      '<img style="max-width:100%;height:auto;float:left;display:block" '
                    )),
                    (e.attribute.productAttr = r.data.productAttr),
                    (e.productValue = r.data.productValue),
                    (e.attribute.productSelect.num = r.data.storeInfo.num),
                    (e.replyCount = r.data.replyCount),
                    (e.reply = r.data.reply ? [r.data.reply] : []),
                    (e.replyChance = r.data.replyChance),
                    (i.routineContact = Number(r.data.routine_contact_type)),
                    r.data.productValue)) {
                      var o = r.data.productValue[u];
                      i.skuArr.push(o);
                    }
                    e.$set(e, "selectSku", i.skuArr[0]),
                      t.setNavigationBarTitle({ title: s.substring(0, 7) + "..." }),
                      i.DefaultSelect();
                  })
                  .catch(function (t) {
              ...
              DefaultSelect: function () {
                ...
                for (var r = 0; r < t.length; r++) this.$set(t[r], "index", e[r]);
                var s = this.productValue[e.join(",")];
                s && t.length
                  ? (this.$set(this.attribute.productSelect, "store_name", this.storeInfo.title),
                    this.$set(this.attribute.productSelect, "image", s.image),
                    this.$set(this.attribute.productSelect, "price", s.price),
                    this.$set(this.attribute.productSelect, "stock", s.stock),
                    this.$set(this.attribute.productSelect, "unique", s.unique),
                    this.$set(this.attribute.productSelect, "quota", s.quota),
                    this.$set(this.attribute.productSelect, "quota_show", s.quota_show),
                    this.$set(this.attribute.productSelect, "product_stock", s.product_stock),
              ...
              scroll: function (t) {
                ...
                if (((i = i > 1 ? 1 : i), (this.opacity = i), (this.currentPage = !1), (this.scrollY = e), this.lock))
                  ...
                  for (var r = 0; r < this.topArr.length; r++)
                    if (e < this.topArr[r] - h.globalData.navHeight / 2 + this.heightArr[r]) {
                      this.navActive = r;
                      break;
                    }
              },
              tap: function (t, e) {
                ...
                (this.toView = i),
                  (this.navActive = e),
                  (this.lock = !0),
                  (this.scrollTop = e > 0 ? this.topArr[e] - h.globalData.navHeight / 2 : this.topArr[e]);
              },
              showImg: function (t) {
                this.$refs.cusPreviewImg.open(this.selectSku.suk);
              },
              listenerActionSheet: function () {
                if (((this.currentPage = !1), !1 === this.isLogin)) (0, a.toLogin)();
                else {
                  if (this.posterImage) return void (this.posters = !0);
                  this.downloadFilePromotionCode(), (this.posters = !0);
                }
              },
              ...
              goCat: function () {
                ...
                return (
                  ...
                  !0 === this.attribute.cartAttr && 0 == this.isOpen
                    ...
                    ? h.$util.Tips({ title: this.$t("请选择属性") })
                    : this.cart_num <= 0
                    ? h.$util.Tips({ title: this.$t("请选择数量") })
                    : ((this.isOpen = !1),
                      void t.navigateTo({
  ...
  [["4740", "common/runtime", "common/vendor"]],
]);
