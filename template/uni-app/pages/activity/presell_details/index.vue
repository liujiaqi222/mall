  ...
  <view class="product-con" :style="colorStyle">
    ...
    <view class="footer acea-row row-between-wrapper">
      ...
      <view class="bnt acea-row" v-if=" pay_status === 1 || pay_status === 3 ">
        <form @submit=" goBuy " class="buy bnts bg-color-hui"><button class="buy bnts" form-type="submit">{{pay_status
            ===
            1?$t(`未开始`):$t(`已结束`)}}</button></form>
      </view>
      <view class="bnt acea-row"
        ...
        <form class="buy bnts bg-color-hui"><button class="buy bnts bg-color-hui"
            form-type="submit">{{$t(`已售罄`)}}</button>
        </form>
      </view>
      <view class="bnt acea-row" v-else-if=" pay_status === 2 ">
        <form @submit=" goBuy " class="buy bnts"><button class="buy bnts" form-type="submit">{{$t(`立即购买`)}}</button>
        </form>
      </view>
    </view>
    ...
    <!-- 组件 -->
    <productWindow :attr=" attr " :isShow=" 0 " :limitNum=" 1 " :iSplus=" 1 " @myevent=" onMyEvent "
      @ChangeAttr=" ChangeAttr " @ChangeCartNum=" ChangeCartNum " @attrVal=" attrVal " @iptCartNum=" iptCartNum "
      id="product-window" :is_vip=" is_vip " @getImg=" showImg "></productWindow>
