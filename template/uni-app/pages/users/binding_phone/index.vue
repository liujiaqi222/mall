  ...
  <view class="wrapper" :style="colorStyle">
    ...
    <view class="page-form">
      ...
      <view class="item acea-row row-between-wrapper">
        <input type='number' :placeholder='$t(`填写验证码`)' placeholder-class='placeholder' :maxlength="6" class="codeIput"
    ...
    <Verify @success="success" :captchaType="'clickWord'" :imgSize="{ width: '330px', height: '155px' }" ref="verify">
    </Verify>
