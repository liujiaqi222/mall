  ...
  <view>
    <view v-if="isShow && tabTitle.length">
      ...
      <view class="navTabBox" :style="'color:' + txtColor + ';'" :class="{ isFixed: isFixed }">
        <view class="longTab">
          <scroll-view scroll-x="true" style="white-space: nowrap; display: flex;  align-items: center; height: 50rpx;"
    ...
    <view v-if="!isShow && tabTitle.length && isIframe">
      ...
      <view class="navTabBox" :style="'color:' + txtColor + ';top:' + isTop" :class="{ isFixed: isFixed }">
        <view class="longTab">
          <scroll-view scroll-x="true" style="white-space: nowrap; display: flex; align-items: center;"
            scroll-with-animation :scroll-left="tabLeft" show-scrollbar="true">
