    ...
    <view v-if="!errorNetwork" :style="colorStyle">
      ...
      <view class="index skeleton" :style="{ visibility: showSkeleton ? 'hidden' : 'visible' }">
        ...
        <block v-for="(item, index) in styleConfig" :key="index">
          ...
          <combination v-if="item.name == 'combination' && $permission('combination')" :dataConfig="item"
          ...
          <goodList v-if="item.name == 'goodList'" :dataConfig="item" @detail="goDetail" :isSortType="isSortType">
          </goodList>
          ...
          <seckill v-if="item.name == 'seckill' && $permission('seckill')" :dataConfig="item" :isSortType="isSortType">
          </seckill>
          ...
          <tabNav v-if="item.name == 'tabNav'" :dataConfig="item" @bindHeight="bindHeighta" @bindSortId="bindSortId"
        ...
        <view v-if="site_config.network_security" class="site-config" @click="goICP(2)">{{ site_config.network_security
          }}</view>
        <!-- #endif -->
