  ...
  <view class="goodCate">
    ...
    <view class="conter">
      ...
      <view class="wrapper">
        ...
        <scroll-view scroll-y="true" scroll-with-animation="true" :scroll-top="0" @scroll="scroll"
          :style="{ height: scrollHeight * 2 + 'rpx' }" :lower-threshold="50" @scrolltolower="productslist">
          <goodClass ref="goodClass" :tempArr="tempArr" :isLogin="isLogin" @gocartduo="goCartDuo" @gocartdan="goCartDan"
            @ChangeCartNumDan="ChangeCartNumDan" @detail="goDetail" :endLocation="endLocation" @addCart="addCart">
          </goodClass>
    ...
    <productWindow :attr="attr" :minQty="storeInfo.min_qty" :isShow="1" :iSplus="1" :iScart="1" @myevent="onMyEvent"
