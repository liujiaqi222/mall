  ...
  <view class="goodCate">
    ...
    <view class="conter">
      ...
      <view class="wrapper">
        ...
        <scroll-view scroll-y="true" scroll-with-animation="true" :scroll-top="scrollTop" @scroll="scroll"
          style="height: calc(100vh - 324rpx)" :lower-threshold="50" @scrolltolower="productslist">
